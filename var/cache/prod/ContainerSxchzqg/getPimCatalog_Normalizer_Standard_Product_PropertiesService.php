...
if ($lazyLoad) {
    return $this->services['pim_catalog.normalizer.standard.product.properties'] = $this->createProxy('PropertiesNormalizer_47156f3', function () {
        return \PropertiesNormalizer_47156f3::staticProxyConstructor(function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) {
