...
return $this->services['form.registry'] = new \Symfony\Component\Form\FormRegistry(array(0 => new \Symfony\Component\Form\Extension\DependencyInjection\DependencyInjectionExtension(new \Symfony\Component\DependencyInjection\ServiceLocator(array('Akeneo\\Tool\\Bundle\\FileStorageBundle\\Form\\Type\\FileInfoType' => function () {
    ...
    yield 4 => ${($_ = isset($this->services['pim_ui.form.extension.help']) ? $this->services['pim_ui.form.extension.help'] : $this->services['pim_ui.form.extension.help'] = new \Akeneo\Platform\Bundle\UIBundle\Form\Extension\FormTypeHelpExtension()) && false ?: '_'};
    yield 5 => ${($_ = isset($this->services['pim_ui.form.extension.select2']) ? $this->services['pim_ui.form.extension.select2'] : $this->services['pim_ui.form.extension.select2'] = new \Akeneo\Platform\Bundle\UIBundle\Form\Extension\FormTypeSelect2Extension()) && false ?: '_'};
