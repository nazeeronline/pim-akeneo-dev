...
if ($lazyLoad) {
    return $this->services['pim_catalog.normalizer.standard.product_model'] = $this->createProxy('ProductModelNormalizer_89097a1', function () {
        return \ProductModelNormalizer_89097a1::staticProxyConstructor(function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) {
