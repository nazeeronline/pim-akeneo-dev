...
if ($lazyLoad) {
    return $this->services['pim_catalog.normalizer.standard.product.product_value'] = $this->createProxy('ProductValueNormalizer_d9f094d', function () {
        return \ProductValueNormalizer_d9f094d::staticProxyConstructor(function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) {
