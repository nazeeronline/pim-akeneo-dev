...
$catalogue = new MessageCatalogue('pt_BR', array (
  ...
  array (
    ...
    'akeneo_batch.job_instance.unknown_job_definition' => 'Falha ao criar %job_type% com uma definição de trabalho indefinida',
    ...
    'Attribute code may contain only letters (at least one), numbers and underscores' => 'O código de atributo pode conter apenas letras (ao menos uma), números e sublinhados',
    'This attribute type can\'t be used as a grid filter' => 'Esse tipo de atributo não pode ser usado como um filtro',
    ...
    'This attribute type can\'t be required' => 'Este tipo de atributo não pode ser obrigatório',
    'This attribute type can\'t have unique value' => 'Este tipo de atributo não pode ter um único valor',
    'No default value may be specified for this attribute type' => 'Nenhum valor padrão pode ser especificado para esse tipo de atributo',
    'This value should be Yes or No' => 'Este valor deveria ser Sim ou Não',
    'This value should not be blank' => 'Este valor não pode estar vazio',
    'Option code may contain only letters, numbers and underscores' => 'Código da opção deve conter apenas letras, números e sublinhados',
    'Option code may contain only letters (at least one), numbers and underscores' => 'O código da opção pode conter apenas letras (ao menos uma), numeros e sublinhados',
    'This value should not be a decimal.' => 'Este valor não deve ser um decimal.',
    'The file extension is not allowed (allowed extensions: %extensions%).' => 'A extensão do arquivo não é permitida (extensões permitidas: %extensions%).',
    'The value %value% is already set on another product for the unique attribute %attribute%' => 'O Valor %value% já está em uso por outro produto para o atributo unico %attribute%',
    'regex.comma_or_semicolon.message' => 'Esse campo não deve conter vírgula ou ponto e vírgula.',
    'file.extensions.message' => 'A extensão do arquivo não é permitida (extensões permitidas: %extensions%).',
    'This type of value expects the use of {{ decimal_separator }} to separate decimals.' => 'Este tipo de valor espera a utilização de {{ decimal_separator }} para separar casas decimais.',
    'This type of value expects the use of dot (.) to separate decimals.' => 'Este tipo de valor espera a utilização de um ponto final (.) para separar casas decimais.',
    'This type of value expects the use of comma (,) to separate decimals.' => 'Este tipo de valor espera a utilização de uma vírgula (,) para separar casas decimais.',
    'This type of value expects the use of arabic decimal separator (٫) to separate decimals.' => 'Este tipo de valor espera a utilização de um separador decimal arábico (,) para separar casas decimais.',
    'This type of value expects the use of the format {{ date_format }} for dates.' => 'Este tipo de valor espera a utilização do formato {{ date_format }} para datas.',
    'pim_catalog.constraint.product_identifier' => 'Esses identificadores "%s" não existem.',
    'pim_catalog.constraint.0' => 'Ocorreu um erro inesperado.',
    'pim_catalog.constraint.100' => 'Valor não esperado',
    'pim_catalog.constraint.101' => 'Este campo espera um valor numérico.',
    'pim_catalog.constraint.102' => 'Este campo espera um valor numérico.',
    'pim_catalog.constraint.103' => 'Este campo espera um valor numérico.',
    'pim_catalog.constraint.104' => 'Este campo espera um valor numérico.',
    'pim_catalog.constraint.105' => 'Este campo espera um valor numérico.',
    'pim_catalog.constraint.106' => 'Este campo espera um valor numérico.',
    'pim_catalog.constraint.107' => 'Este campo espera uma matriz de matrizes como valor.',
    'pim_catalog.constraint.200' => 'Ocorreu um erro interno',
    'pim_catalog.constraint.201' => 'Ocorreu um erro interno',
    'pim_catalog.constraint.202' => 'Este campo espera um valor numérico.',
    'pim_catalog.constraint.203' => 'Este campo espera um valor numérico.',
    'pim_catalog.constraint.204' => 'Este campo espera um valor numérico.',
    'pim_catalog.constraint.205' => 'Ocorreu um erro interno',
    'pim_catalog.constraint.300' => 'Este campo espera um código de entidade válida.',
    'pim_catalog.constraint.301' => 'Este campo espera um código de entidade válida.',
    'pim_catalog.constraint.302' => 'Este campo espera um escopo válido.',
    'pim_catalog.constraint.303' => 'Este campo espera um formato válido de associação.',
    'This directory is not writable' => 'Esse diretório não tem permissão de escrita.',
    'This directory is not valid' => 'Esse não é um diretório válido.',
    'pim_import_export.job_instance.unknown_job_definition' => 'Falha ao criar %job_type% com uma definição de trabalho indefinida',
    'This code is already taken' => 'Esse código já está em uso',
  ),
  'security' => 
  array (
  ...
  'messages' => 
  array (
    'pim_connector.steps.dummy_reader.title' => 'Leitor fictício',
    'pim_connector.steps.product_reader.title' => 'Extração de Produto',
    'pim_connector.steps.entity_reader.title' => 'Extração de Entidade',
    'pim_connector.steps.csv_reader.title' => 'Leitor de CSV',
    'pim_connector.steps.csv_product_reader.title' => 'Leitor CSV de Produtos',
    'pim_connector.steps.csv_category_reader.title' => 'Leitor CSV de Categoria',
    'pim_connector.steps.dummy_processor.title' => 'Processador modelo',
    'pim_connector.steps.product_processor.title' => 'Criação de Produto',
    'pim_connector.steps.category_processor.title' => 'Criação de categoria',
    'pim_connector.steps.association_processor.title' => 'Criação de associação',
    'pim_connector.steps.product_association_processor.title' => 'Criação de associação',
    'pim_connector.steps.group_processor.title' => 'Criação de grupo',
    'pim_connector.steps.attribute_processor.title' => 'Criação de atributo',
    'pim_connector.steps.attribute_option_processor.title' => 'Criação de opção de atributo',
    'pim_connector.steps.heterogeneous_processor.title' => 'Serializador CSV de Produto',
    'pim_connector.steps.homogeneous_processor.title' => 'Serializador CSV de Entidade',
    'pim_connector.steps.transformer_processor.title' => 'Transformação',
    'pim_connector.steps.dummy_writer.title' => 'Escritor modelo',
    'pim_connector.steps.file_writer.title' => 'Saída',
    'pim_connector.steps.product_writer.title' => 'Armazenamento de Produto',
    'pim_connector.steps.category_writer.title' => 'Armazenamento de Categoria',
    'pim_connector.steps.writer.title' => 'Armazenamento de Entidade',
    'pim_connector.steps.csv_writer.title' => 'Escritor de CSV',
    'job_execution.summary.read' => 'ler',
    'job_execution.summary.write' => 'escrever',
    'job_execution.summary.skip' => 'pulado',
    'job_execution.summary.create' => 'criado',
    'job_execution.summary.process' => 'processado',
    'job_execution.summary.update_products' => 'produtos atualizados',
    'job_execution.summary.process_products' => 'produtos processados',
    'job_execution.summary.skip_products' => 'produtos pulados',
    'job_execution.summary.displayed' => 'primeiros alertas exibidos',
    'job_execution.summary.charset_validator.title' => 'Codificação do arquivo:',
    'job_execution.summary.charset_validator.skipped' => 'pulado, extensão na lista branca',
    'job_execution.summary.product_skipped_no_diff' => 'produto pulado (nenhuma diferença)',
    'job_execution.summary.product_skipped_no_associations' => 'produto ignorado (associações não detectadas)',
    'job_execution.summary.item_position' => 'ler linhas',
    'batch_jobs.csv_product_export.label' => 'Exportação de produto em CSV',
    'batch_jobs.csv_product_export.export.label' => 'Exportação de produto',
    'batch_jobs.csv_category_export.label' => 'Exportação de categoria em CSV',
    'batch_jobs.csv_category_export.export.label' => 'Exportação de categoria',
    'batch_jobs.csv_attribute_export.label' => 'Exportação de atributo em CSV',
    'batch_jobs.csv_attribute_export.export.label' => 'Exportação de atributo',
    'batch_jobs.csv_attribute_option_export.label' => 'Exportação de opções de atributo em CSV',
    'batch_jobs.csv_attribute_option_export.export.label' => 'Exportação de opções de atributo',
    'batch_jobs.csv_association_type_export.label' => 'Exportação de tipo de associação em CSV',
    'batch_jobs.csv_association_type_export.export.label' => 'Exportação de tipo de associação',
    'batch_jobs.csv_group_export.label' => 'Exportação de grupo em CSV',
    'batch_jobs.csv_group_export.export.label' => 'Exportação de grupo',
    'batch_jobs.csv_family_export.label' => 'Exportação de família em CSV',
    'batch_jobs.csv_family_export.export.label' => 'Exportação de família',
    'batch_jobs.csv_product_import.label' => 'Importação de produto em CSV',
    'batch_jobs.csv_product_import.validation.label' => 'Validação de arquivo',
    'batch_jobs.csv_product_import.import.label' => 'Importação de produto',
    'batch_jobs.csv_product_import.import_associations.label' => 'Importação de associação',
    'batch_jobs.csv_product_model_import.validation.label' => 'Validação de arquivo',
    'batch_jobs.csv_category_import.label' => 'Importação de categoria em CSV',
    'batch_jobs.csv_category_import.validation.label' => 'Validação de arquivo',
    'batch_jobs.csv_category_import.import.label' => 'Importação de categoria',
    'batch_jobs.csv_attribute_import.label' => 'Importação de atributo em CSV',
    'batch_jobs.csv_attribute_import.validation.label' => 'Validação de arquivo',
    'batch_jobs.csv_attribute_import.import.label' => 'Importação de atributo',
    'batch_jobs.csv_attribute_option_import.label' => 'Importação de opções de atributo em CSV',
    'batch_jobs.csv_attribute_option_import.validation.label' => 'Validação de arquivo',
    'batch_jobs.csv_attribute_option_import.import.label' => 'Importação de opções de atributo',
    'batch_jobs.csv_association_type_import.label' => 'Importação de tipo de associação em CSV',
    'batch_jobs.csv_association_type_import.validation.label' => 'Validação de arquivo',
    'batch_jobs.csv_association_type_import.import.label' => 'Importação de tipo de associação',
    'batch_jobs.csv_family_import.label' => 'Importar família em CSV',
    'batch_jobs.csv_family_import.validation.label' => 'Validação de arquivo',
    'batch_jobs.csv_family_import.import.label' => 'Importar família',
    'batch_jobs.csv_family_variant_import.validation.label' => 'Validação de arquivo',
    'batch_jobs.csv_group_import.label' => 'Importação de grupo em CSV',
    'batch_jobs.csv_group_import.validation.label' => 'Validação de arquivo',
    'batch_jobs.csv_group_import.import.label' => 'Importação de grupo',
    'batch_jobs.csv_channel_export.label' => 'Exportação de canal em CSV',
    'batch_jobs.csv_channel_export.export.label' => 'Exportação de canal',
    'batch_jobs.csv_locale_export.label' => 'Exportação de localidade em CSV',
    'batch_jobs.csv_locale_export.export.label' => 'Exportação de localidade',
    'batch_jobs.csv_attribute_group_export.label' => 'Exportação de grupo de atributos em CSV',
    'batch_jobs.csv_attribute_group_export.export.label' => 'Exportação de grupo de atributos',
    'batch_jobs.csv_currency_export.label' => 'Exportação de moeda em CSV',
    'batch_jobs.csv_currency_export.export.label' => 'Exportação de moeda',
    'batch_jobs.csv_group_type_export.label' => 'Exportação de tipos de grupo em CSV',
    'batch_jobs.csv_group_type_export.export.label' => 'Exportação de tipos de grupo',
    'batch_jobs.csv_channel_import.label' => 'Importação de canal em CSV',
    'batch_jobs.csv_channel_import.validation.label' => 'Validação de arquivo',
    'batch_jobs.csv_channel_import.import.label' => 'Importação de canal',
    'batch_jobs.csv_locale_import.label' => 'Importação de localidade em CSV',
    'batch_jobs.csv_locale_import.validation.label' => 'Validação de arquivo',
    'batch_jobs.csv_locale_import.import.label' => 'Importação de localidade',
    'batch_jobs.csv_attribute_group_import.label' => 'Importação de grupo de atributos em CSV',
    'batch_jobs.csv_attribute_group_import.validation.label' => 'Validação de arquivo',
    'batch_jobs.csv_attribute_group_import.import.label' => 'Importação de grupo de atributos',
    'batch_jobs.csv_currency_import.label' => 'Importação de moeda em CSV',
    'batch_jobs.csv_currency_import.validation.label' => 'Validação de arquivo',
    'batch_jobs.csv_currency_import.import.label' => 'Importação de moeda',
    'batch_jobs.csv_group_type_import.label' => 'Importação de tipos de grupo em CSV',
    'batch_jobs.csv_group_type_import.validation.label' => 'Validação de arquivo',
    'batch_jobs.csv_group_type_import.import.label' => 'Grupo tipo importação',
    'batch_jobs.xlsx_category_import.validation.label' => 'Validação de arquivo',
    'batch_jobs.xlsx_category_import.import.label' => 'Importação de categoria',
    'batch_jobs.xlsx_association_type_import.validation.label' => 'Validação de arquivo',
    'batch_jobs.xlsx_association_type_import.import.label' => 'Importação de tipo de associação',
    'batch_jobs.xlsx_attribute_import.validation.label' => 'Validação de arquivo',
    'batch_jobs.xlsx_attribute_import.import.label' => 'Importação de atributo',
    'batch_jobs.xlsx_attribute_option_import.validation.label' => 'Validação de arquivo',
    'batch_jobs.xlsx_attribute_option_import.import.label' => 'Importação de opções de atributo',
    'batch_jobs.xlsx_family_import.validation.label' => 'Validação de arquivo',
    'batch_jobs.xlsx_family_import.import.label' => 'Importar família',
    'batch_jobs.xlsx_family_variant_import.validation.label' => 'Validação de arquivo',
    'batch_jobs.xlsx_product_export.export.label' => 'Exportação de produto',
    'batch_jobs.xlsx_product_import.validation.label' => 'Validação de arquivo',
    'batch_jobs.xlsx_product_import.import.label' => 'Importação de produto',
    'batch_jobs.xlsx_product_import.import_associations.label' => 'Importação de associação',
    'batch_jobs.xlsx_product_model_import.validation.label' => 'Validação de arquivo',
    'batch_jobs.xlsx_group_export.label' => 'Exportação de grupos em XLSX',
    'batch_jobs.xlsx_group_export.export.label' => 'Exportação de grupo',
    'batch_jobs.xlsx_group_import.label' => 'Importação de grupos em XLSX',
    'batch_jobs.xlsx_group_import.validation.label' => 'Validação de arquivo',
    'batch_jobs.xlsx_group_import.import.label' => 'Importação de grupo',
    'batch_jobs.xlsx_family_export.label' => 'Exportação de famílias em XLSX',
    'batch_jobs.xlsx_family_export.export.label' => 'Exportação de família',
    'batch_jobs.xlsx_category_export.label' => 'Exportação de categorias em XLSX',
    'batch_jobs.xlsx_category_export.export.label' => 'Exportação de categoria',
    'batch_jobs.xlsx_attribute_export.label' => 'Exportação de atributos em XLSX',
    'batch_jobs.xlsx_attribute_export.export.label' => 'Exportação de atributos em XLSX',
    'batch_jobs.xlsx_attribute_option_export.label' => 'Exportação de opções de atributos em XLSX',
    'batch_jobs.xlsx_attribute_option_export.export.label' => 'Exportação de opções de atributos em XLSX',
    'batch_jobs.xlsx_association_type_export.label' => 'Exportação de tipos de associação em XLSX',
    'batch_jobs.xlsx_association_type_export.export.label' => 'Exportação de tipos de associação em XLSX',
    'batch_jobs.xlsx_channel_export.label' => 'Exportação de canais em XLSX',
    'batch_jobs.xlsx_channel_export.export.label' => 'Exportação de canal',
    'batch_jobs.xlsx_locale_export.label' => 'Exportação de localidade em XLSX',
    'batch_jobs.xlsx_locale_export.export.label' => 'Exportação de localidade',
    'batch_jobs.xlsx_attribute_group_export.label' => 'Exportação de grupo de atributos em XLSX',
    'batch_jobs.xlsx_attribute_group_export.export.label' => 'Exportação de grupo de atributos',
    'batch_jobs.xlsx_currency_export.label' => 'Exportação de Moedas em XLSX',
    'batch_jobs.xlsx_currency_export.export.label' => 'Exportação de moeda',
    'batch_jobs.xlsx_group_type_export.label' => 'Exportação de tipos de grupos em XLSX',
    'batch_jobs.xlsx_group_type_export.export.label' => 'Exportação de tipos de grupo',
    'batch_jobs.xlsx_channel_import.label' => 'Importação de canais em XLSX',
    'batch_jobs.xlsx_channel_import.validation.label' => 'Validação de arquivo',
    'batch_jobs.xlsx_channel_import.import.label' => 'Importação de canal',
    'batch_jobs.xlsx_locale_import.label' => 'Importação de localidade em XLSX',
    'batch_jobs.xlsx_locale_import.validation.label' => 'Validação de arquivo',
    'batch_jobs.xlsx_locale_import.import.label' => 'Importação de localidade',
    'batch_jobs.xlsx_attribute_group_import.label' => 'Importação de grupos de atributos em XLSX',
    'batch_jobs.xlsx_attribute_group_import.validation.label' => 'Validação de arquivo',
    'batch_jobs.xlsx_attribute_group_import.import.label' => 'Importação de grupo de atributos',
    'batch_jobs.xlsx_currency_import.validation.label' => 'Validação de arquivo',
    'batch_jobs.xlsx_currency_import.import.label' => 'Importação de moeda',
    'batch_jobs.xlsx_group_type_import.validation.label' => 'Validação de arquivo',
    'batch_jobs.xlsx_group_type_import.import.label' => 'Grupo tipo importação',
    'Area' => 'Área',
    'ACRE' => 'Acre',
    'ARE' => 'Are',
    'ARPENT' => 'Arpent',
    ...
    'MILLIAMPEREHOUR' => 'Miliampère/hora',
    'AMPEREHOUR' => 'Ampère/hora',
    ...
    'PIECE' => 'Peça',
    'DOZEN' => 'Dúzia',
    'rights.api' => 'Permissões de API Web',
    'pim_api.acl.rights' => 'Permissões de API Web',
    'pim_api.acl.attribute.edit' => 'Criar e atualizar atributos',
    'pim_api.acl.attribute.list' => 'Listar atributos',
    'pim_api.acl.attribute_option.edit' => 'Criar e atualizar as opções de atributo',
    'pim_api.acl.attribute_option.list' => 'Lista as opções de atributo',
    'pim_api.acl.attribute_group.list' => 'Listar grupo de atributos',
    'pim_api.acl.category.edit' => 'Criar e atualizar as categorias',
    'pim_api.acl.category.list' => 'Listar categorias',
    'pim_api.acl.family.edit' => 'Criar e atualizar as famílias',
    'pim_api.acl.family.list' => 'Listar famílias',
    'pim_api.acl.channel.list' => 'Listar canais',
    'pim_api.acl.locale.list' => 'Lista de localidades',
    'pim_api.acl.currency.list' => 'Lista de moedas',
    'pim_api.acl.association_type.list' => 'Lista de tipos de associação',
    'pim_api.acl_group.overall_access' => 'Acesso total à API Web',
    'pim_api.acl_group.attribute' => 'Atributos',
    'pim_api.acl_group.attribute_option' => 'Opções de atributo',
    'pim_api.acl_group.attribute_group' => 'Grupo de atributos',
    'pim_api.acl_group.category' => 'Categorias',
    'pim_api.acl_group.family' => 'Famílias',
    'pim_api.acl_group.channel' => 'Canais',
    'pim_api.acl_group.locale' => 'Localidades',
    'pim_api.acl_group.currency' => 'Moedas',
    'pim_api.acl_group.association_type' => 'Tipos de associação',
    ...
    'oro.filter.form.label_type_empty' => 'está vazio',
    'oro.filter.form.label_type_not_empty' => 'não está vazio',
    'oro.filter.form.label_type_in_list' => 'na lista',
    ...
    'datagrid_view.label.unique_message' => 'O rótulo deve ser único',
    'datagrid_view.label.not_blank_message' => 'O rótulo não pode estar vazio',
    'grid.view_selector.flash.created' => 'Visualização de grid criada com sucesso',
    'grid.view_selector.flash.removed' => 'Visualização de grid removida com sucesso',
    'grid.view_selector.flash.not_removable' => 'Você não tem permissão para remover essa visualização',
    'user.title' => 'Usuário',
    'user.overview' => 'Usuário',
    'Users Management' => 'Gerenciamento de usuários',
    'Create user' => 'Criar usuário',
    'btn.create.user' => 'Criar usuário',
    ...
    'Ui locale' => 'Linguagem do UI',
    'UI locale' => 'Linguagem do UI',
    'User salt' => 'Sal de usuário',
    'Current password' => 'Senha atual',
    'New password' => 'Nova senha',
    'Repeat new password' => 'Nova senha (repetir)',
    ...
    'btn.create.user-group' => 'Criar grupo',
    'Has group' => 'Possui grupo',
    'Save and Close' => 'Salvar e Fechar',
    'user-group.overview' => 'Grupos',
    'Log in' => 'Entrar',
    'Remember me on this computer' => 'Lembrar neste computador',
    'Forgot your password?' => 'Esqueceu a senha?',
    'Username or Email' => 'Usuário ou Email',
    'Forgot Password' => 'Esqueci a senha',
    'Request' => 'Requisição',
    'Check Email' => 'Verificar Email',
    'Go to homepage' => 'Ir para Página Inícial',
    'pim_user.user.tab.general.title' => 'Geral',
    'pim_user.user.tab.additional.title' => 'Adicional',
    'pim_user.user.tab.group_and_role.title' => 'Grupos e Funções',
    'pim_user.user.tab.password.title' => 'Senha',
    'pim_user.user.tab.business_unit.title' => 'Unidades de Negócios',
    'pim_user.user.tab.email_synchronization.title' => 'Configurações de sincronização de E-Mail',
    'pim_user.user.tab.interfaces.title' => 'Interfaces',
    'pim_user.group.tab.general.title' => 'Geral',
    'pim_user.group.tab.users.title' => 'Usuários',
    ...
    'pim_title.user.index' => 'Usuários',
    'pim_title.user_role.index' => 'Funções',
    'pim_title.user_group.index' => 'Grupos',
    'pim_title.system_configuration.index' => 'Configuração',
    'user.product_grid_filters' => 'Filtros da grelha de produtos',
    'user.default_product_grid_view.label' => 'Vista da grelha de produtos por defeito',
    'user.default_grid_view.none' => 'Nenhum',
    'user.timezone' => 'Fuso horário',
    'role.title' => 'papel',
    'role.overview' => 'papel',
    'role.edit' => 'Editar Papel',
    'role.create' => 'Criar papel',
    'rights.action' => 'Permissões',
    'oro_security.acl_group.user' => 'Usuários',
    'oro_security.acl_group.role' => 'Funções',
    'oro_security.acl_group.group' => 'Grupo de usuários',
    'oro_security.acl.user.view' => 'Lista de Usuários',
    'oro_security.acl.user.create' => 'Criar um usuário',
    'oro_security.acl.user.edit' => 'Editar usuários',
    'oro_security.acl.user.delete' => 'Remover um usuário',
    'oro_security.acl.role.view' => 'Listar papéis',
    'oro_security.acl.role.create' => 'Criar papel',
    'oro_security.acl.role.edit' => 'Editar papéis',
    'oro_security.acl.role.delete' => 'Remover um papél',
    'oro_security.acl.group.view' => 'Lista de Grupo de usuários',
    'oro_security.acl.group.create' => 'Criar um grupo de usuário',
    'oro_security.acl.group.edit' => 'Editar Grupos de Usuários',
    'oro_security.acl.group.delete' => 'Remover um grupo de usuário',
    ...
    'No products to remove' => 'Não existem produtos a serem removidos',
    'dot (.)' => 'ponto (.)',
    'comma (,)' => 'vírgula (,)',
    'pim_dashboard.title' => 'Painel de controle',
    'pim_dashboard.version' => 'Versão',
    'pim_dashboard.link.label.product' => 'Gerenciar Produtos',
    'pim_dashboard.link.label.category' => 'Gerenciar Categorias',
    'pim_dashboard.link.label.attribute' => 'Gerenciar Atributos',
    'pim_dashboard.link.label.family' => 'Gerenciar Familias',
    'pim_dashboard.widget.error.title' => 'Erro ao carregar widget',
    'pim_dashboard.widget.error.message' => 'O widget \'%alias%\' não existe',
    'pim_dashboard.widget.completeness.title' => 'Plenitude Sobre Canais e Locais',
    'pim_dashboard.widget.last_operations.title' => 'Últimas Operações',
    'pim_dashboard.widget.last_operations.empty' => 'Nenhuma Operação Encontrada',
    ...
    'pim_dashboard.widget.last_operations.profile name' => 'Nome do Profile',
    'pim_dashboard.widget.last_operations.details' => 'Detalhes',
    ...
    'pim_dashboard.widget.last_operations.job_type.mass_edit' => 'Edição em Massa',
    'pim_dashboard.widget.last_operations.job_type.quick_export' => 'Exportação Rápida',
    'pim_analytics.new_patch_available' => 'Novo patch disponível',
    'pim_analytics.system_config.group.notification.title' => 'Notificações',
    'pim_analytics.system_config.group.version_update.title' => 'Atualizações da versão',
    'pim_analytics.system_config.form.version_update.label' => 'Notificação de nova versão',
    'pim_analytics.system_config.form.version_update.tooltip' => 'Envia requisição para o servidor para receber informações sobre novas versões',
    'pim_analytics.system_info.title' => 'Informações do Sistema',
    'pim_analytics.system_info.download' => 'TXT',
    'pim_analytics.info_type.pim_edition' => 'Edição',
    'pim_analytics.info_type.pim_version' => 'Versão',
    'pim_analytics.info_type.pim_storage_driver' => 'Armazenamento',
    'pim_analytics.info_type.pim_environment' => 'Ambiente',
    'pim_analytics.info_type.pim_install_time' => 'Tempo de instalação',
    'pim_analytics.info_type.registered_bundles' => 'Pacotes registrados',
    'pim_analytics.info_type.nb_channels' => 'Número de canais',
    'pim_analytics.info_type.nb_products' => 'Número de produtos',
    'pim_analytics.info_type.nb_attributes' => 'Número de atributos',
    'pim_analytics.info_type.nb_locales' => 'Número de locais',
    'pim_analytics.info_type.nb_families' => 'Número de famílias',
    'pim_analytics.info_type.nb_users' => 'Número de usuários',
    'pim_analytics.info_type.pim_storage_version' => 'Versão de armazenamento',
    'pim_analytics.info_type.os_version' => 'Versão OS',
    'pim_analytics.info_type.php_version' => 'Versão do PHP',
    'pim_analytics.info_type.mysql_version' => 'Versão do MySQL',
    'pim_analytics.info_type.mariadb_version' => 'Versão do MariaDB',
    'pim_analytics.info_type.mongodb_version' => 'Versão do MongoDB',
    'pim_analytics.info_type.server_version' => 'Versão do servidor',
    'pim_analytics.info_type.php_extensions' => 'Extensões do PHP',
    'pim_analytics.acl.system_info.index' => 'Informações do Sistema',
    'pim_menu.item.system_info' => 'Informações do Sistema',
    'Job' => 'Tarefa',
    'Connector' => 'Conector',
    ...
    'Upload and import now' => 'Enviar e Importar Agora',
    ...
    'pim_import_export.batch_status.6' => 'Falha na execução',
    'pim_import_export.batch_status.7' => 'Abandonado',
    'pim_import_export.batch_status.8' => 'Desconhecido',
    'pim_import_export.download_archive.archive' => 'transferir ficheiro gerado | transferir ficheiros gerados',
    ...
    'pim_import_export.download_archive.invalid_xlsx' => 'baixar dados inválidos',
    'pim_import_export.download_archive.invalid_csv' => 'baixar dados inválidos',
    'pim_import_export.notification.export.error' => 'Exportação <strong>%label%</strong> falhou',
    'pim_import_export.notification.export.warning' => 'Exportação <strong>%label%</strong> terminou com alguns avisos',
    'pim_import_export.notification.export.success' => 'Exportação <strong>%label%</strong> completa',
    'pim_import_export.notification.import.error' => 'Importação <strong>%label%</strong> falhou',
    'pim_import_export.notification.import.warning' => 'Importação <strong>%label%</strong> terminou com alguns avisos',
    'pim_import_export.notification.import.success' => 'Importação <strong>%label%</strong> completa',
    'pim_import_export.list' => 'Selecione uma tarefa',
    'pim_import_export.job_profile.tab.property.title' => 'Propriedades gerais',
    'pim_import_export.job_profile.tab.history.title' => 'Histórico',
    'pim_import_export.job_profile.tab.job_content.title' => 'Conteúdo',
    'export profile.title' => 'perfil de exportação',
    'export profile.edit' => 'editar perfil de exportação',
    'import profile.title' => 'perfil de importação',
    ...
    'pim_importexport.acl.export_profile.history' => 'Visualizar histórico de exportação de perfil',
    ...
    'pim_importexport.acl.import_profile.history' => 'Visualizar histórico de impotação de perfil',
    ...
    'pim_importexport.acl_group.export' => 'Perfis de exportação',
    'pim_importexport.acl_group.import' => 'Perfis de importação',
    'btn.create.export profile' => 'criar perfil de exportação',
    'btn.create.import profile' => 'criar perfil de importação',
    ...
    'flash.export.running' => 'A exportação está sendo executado',
    ...
    'flash.import.running' => 'A importação está em execução',
    ...
    'job_execution.summary.update' => 'atualizado',
    'User' => 'Usuário',
    ...
    'pim_ui.system_config.group.loading_message.title' => 'Carregando mensagens',
  ),
  'jsmessages' => 
  array (
    'Area' => 'Área',
    ...
    'oro_filter.filters.manage' => 'Gerenciar filtros',
    'oro_filter.placeholder.all' => 'Todos',
    ...
    'View per page' => 'Visualização por Página',
    'Enabled' => 'Habilitado',
    'Disabled' => 'Desabilitado',
    'not_available' => 'Não aplicável',
    'Yes' => 'Sim',
    'No' => 'Não',
    ...
    'oro.datagrid.action.reset' => 'Resetar',
    'oro.datagrid.action.refresh' => 'Atualizar',
    ...
    'Displayed Columns' => 'Colunas selecionadas',
    'datagrid_view.columns.min_message' => 'Você deve selecionar ao menos uma coluna para exibição',
    'pim.grid.mass_action.quick_export.title' => 'Exportação rápida',
    'pim.grid.mass_action.quick_export.launched' => 'A exportação rápida foi iniciada',
    'pim.grid.action.launch.title' => 'Começar',
    'pim.grid.action.show.title' => 'Exibir',
    'Please select view' => 'Por favor, selecione uma visualização',
    'Loading...' => 'Carregando...',
    'View' => 'Visão',
    'grid.view_selector.flash.updated' => 'Visualização de grid atualizada com sucesso',
    'pim.grid.choice_filter.label_empty' => 'está vazio',
    'pim.grid.choice_filter.label_not_empty' => 'não está vazio',
    'pim.grid.choice_filter.label_in_list' => 'na lista',
    'pim.grid.price_filter.label' => 'Moeda',
    'pim.grid.category_filter.done' => 'Cocluído',
    'pim_datagrid.column_configurator.label' => 'Colunas',
    'pim_datagrid.column_configurator.all_groups' => 'Todos os Grupos',
    'pim_datagrid.column_configurator.search' => 'Pesquisar',
    'pim_datagrid.column_configurator.clear' => 'Limpar',
    'pim_datagrid.column_configurator.displayed_columns' => 'Colunas selecionadas',
    'pim_datagrid.column_configurator.apply' => 'Aplicar',
    'pim_datagrid.column_configurator.cancel' => 'Cancelar',
    'pim_datagrid.column_configurator.remove_column' => 'Remover',
    'pim_datagrid.column_configurator.attribute_groups' => 'Grupo de atributos',
    'pim_datagrid.mass_action.delete.confirm_title' => 'Confirmar exclusão',
    'pim_datagrid.mass_action.delete.confirm_ok' => 'OK',
    'pim_datagrid.mass_action.delete.empty_selection' => 'Nenhum produto selecionado',
    'grid.view_selector.default_view' => 'Vista por defeito',
    'grid.view_selector.save_changes' => 'Salvar essa visualização',
    'grid.view_selector.remove' => 'Deletar essa visualização',
    'grid.view_selector.create_view' => 'Criar Visualização',
    'grid.view_selector.create' => 'Criar',
    'grid.view_selector.search' => 'Pesquisar',
    'grid.view_selector.views' => 'Visualizações',
    'grid.view_selector.placeholder' => 'Nome da visualização',
    'grid.view_selector.choose_label' => 'Escolha um rótulo para a visualização',
    'grid.view_selector.confirmation.delete' => 'Confirmar exclusão',
    'pim_dashboard.widget.last_operations.empty' => 'Nenhuma Operação Encontrada',
    'pim_dashboard.widget.last_operations.status' => 'Status',
    'pim_dashboard.widget.last_operations.date' => 'Data',
    'pim_dashboard.widget.last_operations.type' => 'Tipo',
    'pim_dashboard.widget.last_operations.profile_name' => 'Nome do Profile',
    'pim_dashboard.widget.last_operations.details' => 'Detalhes',
    ...
    'pim_dashboard.widget.last_operations.job_type.mass_edit' => 'Edição em Massa',
    'pim_dashboard.widget.last_operations.job_type.quick_export' => 'Exportação Rápida',
    'pim_dashboard.widget.completeness.load_more' => 'Carregar mais...',
    'pim_dashboard.widget.header.view_all' => 'Visualizar tudo',
    'page_title.pim_dashboard_index' => 'Painel de controle',
    'job_execution.summary.display_item' => 'Mostrar item',
    'job_execution.summary.hide_item' => 'Esconder item',
    'pim_connector.export.categories.selector.modal.title' => 'Seleção de categorias',
    'pim_connector.export.categories.selector.modal.cancel' => 'Cancelar',
    'pim_connector.export.categories.selector.modal.confirm' => 'Confirmar',
    'pim_connector.export.categories.selector.label' => '{0} todos os produtos |{1} uma categoria selecionada |] 1, Inf [{{ count }} categorias selecionadas',
    'pim_connector.export.categories.selector.edit' => 'Editar',
    'pim_connector.export.categories.selector.title' => 'Selecionar categorias',
    'pim_connector.export.locales.validation.not_blank' => 'Uma localidade deve ser selecionado, por favor, escolha um local para exportar.',
    'page_title.pim_importexport_export_profile_index' => 'Gerenciamento dos perfis de exportação',
    'page_title.pim_importexport_export_execution_index' => 'Histórico de execuções de exportação',
    'page_title.pim_importexport_export_execution_show' => 'Execuções de exportação | Detalhes',
    'page_title.pim_importexport_import_profile_index' => 'Gerenciamento dos perfis de importação',
    'page_title.pim_importexport_import_execution_index' => 'Histórico de execuções de importação',
    'page_title.pim_importexport_import_execution_show' => 'Execuções de importação | Detalhes',
    'pim_notification.report' => 'Reportar',
    ...
    'Unit' => 'Unidade',
    'Currency' => 'Moeda',
    'jstree.all' => 'Todos os produtos',
    'jstree.unclassified' => 'Produtos não classificados',
    'jstree.product.all' => 'Todos os produtos',
    'jstree.product.unclassified' => 'Produtos não classificados',
    'jstree.no_tree' => 'Nenhuma árvore de classificação disponível',
    'jstree.include_sub' => 'Incluir subcategorias',
    'jstree.loading' => 'Carregando ...',
    'datetimepicker.days.Sunday' => 'Domingo',
    'datetimepicker.days.Monday' => 'Segunda',
    'datetimepicker.days.Tuesday' => 'Terça',
    'datetimepicker.days.Wednesday' => 'Quarta-Feira',
    'datetimepicker.days.Thursday' => 'Quinta-Feira',
    'datetimepicker.days.Friday' => 'Sexta-Feira',
    'datetimepicker.days.Saturday' => 'Sábado',
    'datetimepicker.daysShort.Sun' => 'Dom',
    'datetimepicker.daysShort.Mon' => 'Seg',
    'datetimepicker.daysShort.Tue' => 'Ter',
    'datetimepicker.daysShort.Wed' => 'Qua',
    'datetimepicker.daysShort.Thu' => 'Qui',
    'datetimepicker.daysShort.Fri' => 'Sex',
    'datetimepicker.daysShort.Sat' => 'Sab',
    'datetimepicker.daysMin.Su' => 'Do',
    'datetimepicker.daysMin.Mo' => 'Se',
    'datetimepicker.daysMin.Tu' => 'Te',
    'datetimepicker.daysMin.We' => 'Qa',
    'datetimepicker.daysMin.Th' => 'Qi',
    'datetimepicker.daysMin.Fr' => 'Sx',
    'datetimepicker.daysMin.Sa' => 'Sa',
    'datetimepicker.months.January' => 'Janeiro',
    'datetimepicker.months.February' => 'Fevereiro',
    'datetimepicker.months.March' => 'Março',
    'datetimepicker.months.April' => 'Abril',
    'datetimepicker.months.May' => 'Maio',
    'datetimepicker.months.June' => 'Junho',
    'datetimepicker.months.July' => 'Julho',
    'datetimepicker.months.August' => 'Agosto',
    'datetimepicker.months.September' => 'Setembro',
    'datetimepicker.months.October' => 'Outubro',
    'datetimepicker.months.November' => 'Novembro',
    'datetimepicker.months.December' => 'Dezembro',
    'datetimepicker.monthsShort.Jan' => 'Jan',
    'datetimepicker.monthsShort.Feb' => 'Fev',
    'datetimepicker.monthsShort.Mar' => 'Mar',
    'datetimepicker.monthsShort.Apr' => 'Abr',
    'datetimepicker.monthsShort.May' => 'Maio',
    ...
    'datetimepicker.monthsShort.Oct' => 'Out',
    'datetimepicker.monthsShort.Nov' => 'Nov',
    'datetimepicker.monthsShort.Dec' => 'Dez',
    'oro_config.form.config.title' => 'Configuração do sistema',
    'oro_config.form.config.tab.system.title' => 'Sistema',
    'oro_config.form.config.group.localization.title' => 'Localização',
    'oro_config.form.config.group.localization.system_locale' => 'Idioma',
    'oro_config.form.config.group.notification.title' => 'Notificações',
    'oro_config.form.config.group.notification.system_notification' => 'Notificação de nova versão',
    'oro_config.form.config.group.loading_message.title' => 'Carregando mensagens',
  ),
));
