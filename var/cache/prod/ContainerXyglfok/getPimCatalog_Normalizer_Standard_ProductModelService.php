...
if ($lazyLoad) {
    return $this->services['pim_catalog.normalizer.standard.product_model'] = $this->createProxy('ProductModelNormalizer_68a0649', function () {
        return \ProductModelNormalizer_68a0649::staticProxyConstructor(function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) {
