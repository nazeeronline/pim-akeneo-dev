...
if ($lazyLoad) {
    return $this->services['pim_catalog.normalizer.standard.product.product_value'] = $this->createProxy('ProductValueNormalizer_031b1c6', function () {
        return \ProductValueNormalizer_031b1c6::staticProxyConstructor(function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) {
