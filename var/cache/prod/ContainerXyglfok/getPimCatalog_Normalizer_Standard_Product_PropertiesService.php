...
if ($lazyLoad) {
    return $this->services['pim_catalog.normalizer.standard.product.properties'] = $this->createProxy('PropertiesNormalizer_89e4a68', function () {
        return \PropertiesNormalizer_89e4a68::staticProxyConstructor(function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) {
