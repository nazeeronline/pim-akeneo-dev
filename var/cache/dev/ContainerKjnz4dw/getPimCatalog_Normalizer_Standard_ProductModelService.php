...
if ($lazyLoad) {
    return $this->services['pim_catalog.normalizer.standard.product_model'] = $this->createProxy('ProductModelNormalizer_7999fae', function () {
        return \ProductModelNormalizer_7999fae::staticProxyConstructor(function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) {
