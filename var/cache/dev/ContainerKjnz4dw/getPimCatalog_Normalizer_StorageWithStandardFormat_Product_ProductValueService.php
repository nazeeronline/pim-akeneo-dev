...
if ($lazyLoad) {
    return $this->services['pim_catalog.normalizer.storage_with_standard_format.product.product_value'] = $this->createProxy('ProductValueNormalizer_df73b37', function () {
        return \ProductValueNormalizer_df73b37::staticProxyConstructor(function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) {
