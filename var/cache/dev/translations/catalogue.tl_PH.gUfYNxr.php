...
$catalogue = new MessageCatalogue('tl_PH', array (
  'messages' => 
  array (
    'pim_connector.steps.dummy_reader.title' => 'Tagabasa ng paunang sulat',
    'pim_connector.steps.product_reader.title' => 'Pagkuha ng produkto',
    'pim_connector.steps.entity_reader.title' => 'Pagkuha ng entity',
    'pim_connector.steps.csv_reader.title' => 'Tagabasa ng CSV',
    'pim_connector.steps.file_reader.invalid_item_columns_count' => 'Inaasahang magkakaroon ng %totalColumnsCount% na bilang ng column, pero may totoong bilang na %itemColumnsCount% sa %filePath%:%lineno%',
    'pim_connector.steps.csv_product_reader.title' => 'Tagabasa ng produkto ng CSV',
    'pim_connector.steps.csv_category_reader.title' => 'Tagabasa ng kategorya ng CSV',
    'pim_connector.steps.dummy_processor.title' => 'Taga-proseso ng paunang sulat',
    'pim_connector.steps.product_processor.title' => 'Taga-gawa ng produkto',
    'pim_connector.steps.category_processor.title' => 'Paggawa ng kategorya',
    'pim_connector.steps.association_processor.title' => 'Paggawa ng asosasyon',
    'pim_connector.steps.product_association_processor.title' => 'Paggawa ng asosasyon',
    'pim_connector.steps.group_processor.title' => 'Paggawa ng grupo',
    'pim_connector.steps.attribute_processor.title' => 'Paggawa ng katangian',
    'pim_connector.steps.attribute_option_processor.title' => 'Paggawa ng pagpipiliang katangian',
    'pim_connector.steps.heterogeneous_processor.title' => 'Taga-serialize ng produktong CSV',
    'pim_connector.steps.homogeneous_processor.title' => 'Taga-serialize ng CSV entity',
    'pim_connector.steps.transformer_processor.title' => 'Pagbabago',
    'pim_connector.steps.dummy_writer.title' => 'Tagasulat ng paunang sulat',
    'pim_connector.steps.file_writer.title' => 'Kinalabasan',
    'pim_connector.steps.product_writer.title' => 'Imbakan ng produkto',
    'pim_connector.steps.category_writer.title' => 'Imbakan ng kategorya',
    'pim_connector.steps.writer.title' => 'Imbakan ng entity',
    'pim_connector.steps.csv_writer.title' => 'Tagasulat ng Csv',
    'job_execution.summary.process' => 'prinoseso',
    'job_execution.summary.process_products' => 'prinosesong produkto',
    'job_execution.summary.product_skipped_no_diff' => 'linaktawang produkto (walang pinagbago)',
    'job_execution.summary.item_position' => 'magbasa ng mga linya',
    'batch_jobs.csv_product_export.label' => 'Pagluwas ng produkto sa CSV',
    'batch_jobs.csv_product_export.export.label' => 'Pagluwas ng produkto',
    'batch_jobs.csv_product_model_export.label' => 'I-eksport ang modelo ng produkto sa CSV',
    'batch_jobs.csv_product_model_export.export.label' => 'Pagluwas ng modelo ng produkto',
    'batch_jobs.csv_category_export.label' => 'Pagluwas ng kategorya sa CSV',
    'batch_jobs.csv_category_export.export.label' => 'Pagluwas ng kategorya',
    'batch_jobs.csv_attribute_export.label' => 'Pagluwas ng katangian sa CSV',
    'batch_jobs.csv_attribute_export.export.label' => 'Pagluwas ng katangian',
    'batch_jobs.csv_attribute_option_export.label' => 'Pagluwas ng pagpipiliang katangian sa CSV',
    'batch_jobs.csv_attribute_option_export.export.label' => 'Pagluwas ng pagpipiliang katangian',
    'batch_jobs.csv_association_type_export.label' => 'Tipo ng asosasyon na pagluwas sa CSV',
    'batch_jobs.csv_association_type_export.export.label' => 'Tip ng asosasyon na pagluwas',
    'batch_jobs.csv_group_export.label' => 'Pagluwas ng grupo sa CSV',
    'batch_jobs.csv_group_export.export.label' => 'Pagluwas ng grupo',
    'batch_jobs.csv_family_export.label' => 'Pagluwas ng pamilya sa CSV',
    'batch_jobs.csv_family_export.export.label' => 'Pagluwas ng pamilya',
    'batch_jobs.csv_family_variant_export.label' => 'I-eksport ang ibat-ibang pamilya sa CSV',
    'batch_jobs.csv_family_variant_export.export.label' => 'I-esksport ang baryante ng pamilya',
    'batch_jobs.csv_product_import.label' => 'Pag-aklas sa CSV',
    'batch_jobs.csv_product_import.validation.label' => 'Pagbibigay-bisa sa file',
    'batch_jobs.csv_product_import.import.label' => 'Pag-angkat ng produkto',
    'batch_jobs.csv_product_import.import_associations.label' => 'Pag-angkat ng asosasyon',
    'batch_jobs.csv_product_model_import.label' => 'Angkatin ang modelo ng produkto sa CSV',
    'batch_jobs.csv_product_model_import.validation.label' => 'Pagbibigay-bisa sa file',
    'batch_jobs.csv_category_import.label' => 'Pag-angkat ng kategorya sa CSV',
    'batch_jobs.csv_category_import.validation.label' => 'Pagbibigay-bisa sa file',
    'batch_jobs.csv_category_import.import.label' => 'Pag-angkat ng kategorya',
    'batch_jobs.csv_attribute_import.label' => 'Pag-angkat ng katangian sa CSV',
    'batch_jobs.csv_attribute_import.validation.label' => 'Pagbibigay-bisa sa file',
    'batch_jobs.csv_attribute_import.import.label' => 'Pag-angkat ng katangian',
    'batch_jobs.csv_attribute_option_import.label' => 'Pag-angkat ng pagpipiliang katangian sa CSV',
    'batch_jobs.csv_attribute_option_import.validation.label' => 'Pagbibigay-bisa sa file',
    'batch_jobs.csv_attribute_option_import.import.label' => 'Pag-angkat ng pagpipiliang katangian',
    'batch_jobs.csv_association_type_import.label' => 'Pag angkat ng tipo ng asosasyon sa CSV',
    'batch_jobs.csv_association_type_import.validation.label' => 'Pagbibigay-bisa sa file',
    'batch_jobs.csv_association_type_import.import.label' => 'Pag-angkat ng tipo ng asosasyon',
    'batch_jobs.csv_family_import.label' => 'Pag-angkat ng pamilya CSV',
    'batch_jobs.csv_family_import.validation.label' => 'Pagbibigay-bisa sa file',
    'batch_jobs.csv_family_import.import.label' => 'Pag-angkat ng pamilya',
    'batch_jobs.csv_family_variant_import.label' => 'Angkatin ang ibat-ibang pamilya sa CSV',
    'batch_jobs.csv_family_variant_import.validation.label' => 'Pagbibigay-bisa sa file',
    'batch_jobs.csv_family_variant_import.import.label' => 'Angkating ang ibat-ibang pamilya',
    'batch_jobs.csv_group_import.label' => 'Grupong pag-angkat sa CSV',
    'batch_jobs.csv_group_import.validation.label' => 'Pagbibigay-bisa sa file',
    'batch_jobs.csv_group_import.import.label' => 'Pag-aangkat ng grupo',
    'batch_jobs.csv_channel_import.validation.label' => 'Pagbibigay-bisa sa file',
    'batch_jobs.csv_locale_import.validation.label' => 'Pagbibigay-bisa sa file',
    'batch_jobs.csv_attribute_group_import.validation.label' => 'Pagbibigay-bisa sa file',
    'batch_jobs.csv_currency_import.validation.label' => 'Pagbibigay-bisa sa file',
    'batch_jobs.csv_group_type_import.validation.label' => 'Pagbibigay-bisa sa file',
    'batch_jobs.xlsx_category_import.validation.label' => 'Pagbibigay-bisa sa file',
    'batch_jobs.xlsx_category_import.import.label' => 'Pag-angkat ng kategorya',
    'batch_jobs.xlsx_association_type_import.label' => 'Pag-angkat ng uri ng asosasyon sa XLSX',
    'batch_jobs.xlsx_association_type_import.validation.label' => 'Pagbibigay-bisa sa file',
    'batch_jobs.xlsx_association_type_import.import.label' => 'Pag-angkat ng tipo ng asosasyon',
    'batch_jobs.xlsx_attribute_import.validation.label' => 'Pagbibigay-bisa sa file',
    'batch_jobs.xlsx_attribute_import.import.label' => 'Pag-angkat ng katangian',
    'batch_jobs.xlsx_attribute_option_import.validation.label' => 'Pagbibigay-bisa sa file',
    'batch_jobs.xlsx_attribute_option_import.import.label' => 'Pag-angkat ng pagpipiliang katangian',
    'batch_jobs.xlsx_family_import.validation.label' => 'Pagbibigay-bisa sa file',
    'batch_jobs.xlsx_family_import.import.label' => 'Pag-angkat ng pamilya',
    'batch_jobs.xlsx_family_variant_import.label' => 'Angkatin ang baryante ng pamilya sa XLSX',
    'batch_jobs.xlsx_family_variant_import.validation.label' => 'Pagbibigay-bisa sa file',
    'batch_jobs.xlsx_family_variant_import.import.label' => 'Angkating ang ibat-ibang pamilya',
    'batch_jobs.xlsx_product_export.export.label' => 'Pagluwas ng produkto',
    'batch_jobs.xlsx_product_model_export.label' => 'I-eksport ang modelo ng produkto sa XLSX',
    'batch_jobs.xlsx_product_model_export.export.label' => 'Pagluwas ng modelo ng produkto',
    'batch_jobs.xlsx_product_import.validation.label' => 'Pagbibigay-bisa sa file',
    'batch_jobs.xlsx_product_import.import.label' => 'Pag-angkat ng produkto',
    'batch_jobs.xlsx_product_import.import_associations.label' => 'Pag-angkat ng asosasyon',
    'batch_jobs.xlsx_product_model_import.label' => 'Angkatin ang modelo ng produkto sa XSLX',
    'batch_jobs.xlsx_product_model_import.validation.label' => 'Pagbibigay-bisa sa file',
    'batch_jobs.xlsx_group_export.export.label' => 'Pagluwas ng grupo',
    'batch_jobs.xlsx_group_import.validation.label' => 'Pagbibigay-bisa sa file',
    'batch_jobs.xlsx_group_import.import.label' => 'Pag-aangkat ng grupo',
    'batch_jobs.xlsx_family_export.export.label' => 'Pagluwas ng pamilya',
    'batch_jobs.xlsx_family_variant_export.export.label' => 'I-esksport ang baryante ng pamilya',
    'batch_jobs.xlsx_category_export.export.label' => 'Pagluwas ng kategorya',
    'batch_jobs.xlsx_channel_import.validation.label' => 'Pagbibigay-bisa sa file',
    'batch_jobs.xlsx_locale_import.validation.label' => 'Pagbibigay-bisa sa file',
    'batch_jobs.xlsx_attribute_group_import.validation.label' => 'Pagbibigay-bisa sa file',
    'batch_jobs.xlsx_currency_import.validation.label' => 'Pagbibigay-bisa sa file',
    'batch_jobs.xlsx_group_type_import.validation.label' => 'Pagbibigay-bisa sa file',
    'Area' => 'Sukat',
    'ACRE' => 'Acre',
    'ARE' => 'Are',
    'ARPENT' => 'Arpent',
    'HECTARE' => 'Hektarya',
    'SQUARE_CENTIMETER' => 'Sentimetro kwadrado',
    'SQUARE_DECIMETER' => 'Desimetro kwadrado',
    'SQUARE_DEKAMETER' => 'Dekametro kwadrado',
    'SQUARE_FOOT' => 'Talampakang kwadrado',
    'SQUARE_FURLONG' => 'Furlong kwadrado',
    'SQUARE_HECTOMETER' => 'Hektometro kwadrado',
    'SQUARE_INCH' => 'Pulgada kwadrado',
    'SQUARE_KILOMETER' => 'Kilometro kwadrado',
    'SQUARE_METER' => 'Metro kwadrado',
    'SQUARE_MIL' => 'Mil kwadrado',
    'SQUARE_MILE' => 'Milya kwadrado',
    'SQUARE_MILLIMETER' => 'Milimetro kwadrado',
    'SQUARE_YARD' => 'Yarda kwadrado',
    'Binary' => 'Binary',
    'BIT' => 'Bit',
    'BYTE' => 'Byte',
    'KILOBYTE' => 'Kilobyte',
    ...
    'YEAR' => 'Taon',
    'Speed' => 'Bilis',
    'FOOT_PER_SECOND' => 'Talampakan kada segundo',
    'FOOT_PER_HOUR' => 'Talampakan kada oras',
    'KILOMETER_PER_HOUR' => 'Kilometro kada oras',
    'METER_PER_HOUR' => 'Metro kada oras',
    'METER_PER_MINUTE' => 'Metro kada minuto',
    'METER_PER_SECOND' => 'Metro kada segundo',
    'MILE_PER_HOUR' => 'Milya kada oras',
    'YARD_PER_HOUR' => 'Yarda kada oras',
    'Temperature' => 'Temperatura',
    'CELSIUS' => 'Sentigrado',
    'FAHRENHEIT' => 'Parenhayt',
    'KELVIN' => 'Kelvin',
    'RANKINE' => 'Rankine',
    'REAUMUR' => 'Reaumur',
    'Volume' => 'Volume',
    ...
    'CUBIC_DECIMETER' => 'Desimetro kubiko',
    'CUBIC_FOOT' => 'Talampakan kubiko',
    'CUBIC_INCH' => 'Pulgada kubiko',
    'CUBIC_METER' => 'Metro kubiko',
    'CUBIC_MILLIMETER' => 'Milimetro kubiko',
    'CUBIC_YARD' => 'Yarda kubiko',
    'GALLON' => 'Galon',
    'LITER' => 'Litro',
    'OUNCE' => 'Onsa',
    'PINT' => 'Pinta',
    ...
    'BAR' => 'Bar',
    'PASCAL' => 'Pascal',
    'HECTOPASCAL' => 'hekto Pascal',
    'MILLIBAR' => 'milli Bar',
    'ATM' => 'Atmospera',
    'PSI' => 'Pound kada pulgada kwadrado',
    'TORR' => 'Torr',
    ...
    'PIECE' => 'Piraso',
    'DOZEN' => 'Dosena',
    'rights.api' => 'Mga pahintulot ng Web API',
    'pim_api.acl.rights' => 'Mga pahintulot ng Web API',
    'pim_api.acl.attribute.edit' => 'Maglikha at mag-update ng mga katangian',
    'pim_api.acl.attribute.list' => 'Listahan ng mga attributes',
    'pim_api.acl.attribute_option.edit' => 'Maglikha at mag-update ng mga pagpipilian na katangian',
    'pim_api.acl.attribute_option.list' => 'Maglista ng mga pagpipilian na katangian',
    'pim_api.acl.attribute_group.edit' => 'Maglikha at mag-update ng mga pangkat ng katangian',
    'pim_api.acl.attribute_group.list' => 'Listahan ng attribute ng mga grupo',
    'pim_api.acl.category.edit' => 'Maglikha at mag-update ng mga kategorya',
    'pim_api.acl.category.list' => 'Listahan ng mga kategorya',
    'pim_api.acl.family.edit' => 'Maglikha at mag-update ng mga pamilya',
    'pim_api.acl.family.list' => 'Listahan ng mga pamilya',
    'pim_api.acl.family_variant.edit' => 'Maglikha at mag-update ng mga baryante ng pamilya',
    'pim_api.acl.family_variant.list' => 'Maglista ng mga baryante ng pamilya',
    'pim_api.acl.channel.edit' => 'Maglikha at mag-update ng mga channel',
    'pim_api.acl.channel.list' => 'Listahan ng mga tsanel',
    'pim_api.acl.locale.list' => 'Listahan ng mga lokal',
    'pim_api.acl.currency.list' => 'Listahan ng mga pera',
    'pim_api.acl.association_type.edit' => 'Maglikha at mag-update ng mga uri ng asosasyon',
    'pim_api.acl.association_type.list' => 'Listahan ng mga uri ng asosasyon',
    'pim_api.acl_group.overall_access' => 'Pagpasok sa kabuuan ng Web API',
    'pim_api.acl_group.attribute' => 'Mga katangian',
    'pim_api.acl_group.attribute_option' => 'Mga pagpipilian sa katangian',
    'pim_api.acl_group.attribute_group' => 'Mga grupo ng katangian',
    'pim_api.acl_group.category' => 'Mga kategorya',
    'pim_api.acl_group.family' => 'Mga pamilya',
    'pim_api.acl_group.family_variant' => 'Mga baryante ng pamilya',
    'pim_api.acl_group.channel' => 'Mga channel',
    'pim_api.acl_group.locale' => 'Mga pinagmulan',
    'pim_api.acl_group.currency' => 'Mga salapi',
    'pim_api.acl_group.association_type' => 'Mga uri ng asosasyon',
    'oro.filter.form.label_type_empty' => 'ay walang laman',
    'oro_datagrid.no_data_hint %entityHint%' => 'Walang %entityHint% na umiiral.',
    'oro_datagrid.label_add_filter' => 'Pamahalaan ang mga salaan',
    'oro_datagrid.label_loading_mask' => 'Naglo-loading.',
    'oro.grid.mass_action.confirm_title' => 'Malawakang Gawain para sa Kompirmasyon',
    'oro.grid.mass_action.confirm_content' => 'Sigurado ka bang gusto mo ito gawin?',
    'oro.grid.mass_action.confirm_ok' => 'Oo, gawin mo',
    'oro.grid.mass_action.error_title' => 'Malawakang Gawain ng error',
    'oro.grid.mass_action.error_content' => 'Hindi makagawa sa malawakang gawain',
    'oro.grid.mass_action.delete.label' => 'Burahin',
    'oro.grid.mass_action.delete.confirm_title' => 'Malawakang Kompirmasyon sa Pagbura',
    'oro.grid.mass_action.delete.confirm_content' => 'Sigurado ka bang burahin mo ang mga napiling mga aytems?',
    'oro.grid.datagrid.page_size.all' => 'Lahat',
    'oro.grid.mass_action.delete.success_message' => '{0} Walang mga entities ang natanggal |{1} Isang entity ay nabura|]1,Inf[ %count% lahat ng mga entities ay nabura',
    'quick_export' => 'Madaliang pagluwas',
    'mass_edit' => 'Malawakang edit',
    'datagrid_view.columns.min_message' => 'Pumili ka kahit isang datagrid kolum para ipakita',
    'datagrid_view.label.unique_message' => 'Ang label ay dapat natatangi',
    'datagrid_view.label.not_blank_message' => 'Nag label ay dapat hindi blangko',
    'grid.view_selector.flash.created' => 'Datagrid na tanawin ay matagumpay na nalikha',
    'grid.view_selector.flash.removed' => 'Datagrid na tanawin ay matagumpay na natanggal',
    'grid.view_selector.flash.not_removable' => 'Wala kang mga karapatan para tanggalin ang tanawin na ito',
    'user.title' => 'Gumagamit',
    'user.overview' => 'Gumagamit',
    'Users Management' => 'Pangangasiwa ng mga gumagamit',
    'Create user' => 'Lumikha ng gumagamit',
    'btn.create.user' => 'Lumikha ng gumagamit',
    'New user' => 'Bagong gumagamit',
    'Additional' => 'Karagdagan',
    'Groups and Roles' => 'Mga grupo at mga tungkulin',
    'Username' => 'Username',
    'Password' => 'Password',
    'Re-enter password' => 'Muling i-type ang password',
    'Name prefix' => 'Prefix ng pangalan',
    'First name' => 'Pangalan',
    'Middle name' => 'Gitnang pangalan',
    'Last name' => 'Apelyido',
    'Name suffix' => 'Pangalan ng suffix',
    'Date of birth' => 'Petsa ng kapanganakan',
    'Avatar' => 'Avatar',
    'Additional emails' => 'Mga karagdagang email',
    'Add another email' => 'Magdagdag ng iba pang email',
    'Catalog locale' => 'Katalog ng lokal',
    'Catalog scope' => 'Katalog ng saklaw',
    'Default tree' => 'Default puno',
    'Business Units' => 'Mga yunit ng negosyo',
    'Email synchronization settings' => 'Sinkronisasyon ng email settings',
    'Host' => 'Host',
    'Port' => 'Daungan',
    'Ssl' => 'SSL',
    'Last logged in' => 'Huling naka-log in',
    'Login count' => 'Bilang ng login',
    'Additional Information' => 'Karagdagang impormasyon',
    'Interfaces' => 'Mga interface',
    'Basic Information' => 'Basic na impormasyon',
    ...
    'Ui locale' => 'UI lokal',
    'UI locale' => 'UI lokal',
    'User salt' => 'Asin ng gumagamit',
    'Current password' => 'Kasalukuyang password',
    'New password' => 'Bagong password',
    'Repeat new password' => 'Bagong password (ulit)',
    'Generate key' => 'Bumuo ng key',
    'Primary' => 'pangunahin',
    'Removed user' => 'Inalis na user',
    'Role' => 'Tungkulin',
    'Owner' => 'May-ari',
    'General' => 'Panlahat',
    'Entity' => 'Entity',
    'Capabilities' => 'Kakayahan',
    'Save and close' => 'I-save at isarado',
    'Has role' => 'May tungkulin',
    'btn.create.role' => 'Lumikha ng tungkulin',
    '(default)' => 'E-default ang pahintulot sa mga entity',
    'VIEW' => 'Tingnan',
    'CREATE' => 'Lumikha',
    'EDIT' => 'I-Edit',
    'DELETE' => 'Burahin',
    ...
    'btn.create.user-group' => 'Lumikha ng grupo',
    'Has group' => 'May grupo',
    'Save and Close' => 'I-save at isarado',
    'user-group.overview' => 'Mga grupo',
    'Log in' => 'Log in',
    'Remember me on this computer' => 'Tandaan mo. ako sa kompyuter na ito',
    'Forgot your password?' => 'Nakalimutan ang iyong password?',
    'Username or Email' => 'Username o email',
    'Forgot Password' => 'Nakalimutang password',
    'Request' => 'Hiling',
    'Check Email' => 'Tsek email',
    'password_reset_email_sent' => 'Ang isang email ay naipadala na sa %email%. Naglalaman ito ng isang link na kailangan mong pindutin para ma-reset ang iyong password.',
    'Go to homepage' => 'Pumunta sa homepage',
    'pim_user.user.tab.general.title' => 'Panlahat',
    'pim_user.user.tab.additional.title' => 'Karagdagang',
    'pim_user.user.tab.group_and_role.title' => 'Mga grupo at mga tungkulin',
    'pim_user.user.tab.password.title' => 'Password',
    'pim_user.user.tab.business_unit.title' => 'Mga yunit ng mga negosyo',
    'pim_user.user.tab.email_synchronization.title' => 'Sinkronisasyon ng email settings',
    'pim_user.user.tab.interfaces.title' => 'Mga interface',
    'pim_user.group.tab.general.title' => 'Panlahat',
    'pim_user.group.tab.users.title' => 'Mga gumagamit',
    'oro.user.controller.group.message.saved' => 'Nai-save na grupo',
    'oro.user.controller.role.message.saved' => 'Nai-save na tungkulin',
    'oro.user.controller.user.message.saved' => 'Nai-save na gumagamit',
    'oro.user.controller.status.message.saved' => 'Nai-save na estado',
    'oro.user.grid.users.columns.username' => 'Username',
    'oro.user.grid.users.columns.email' => 'Email',
    'oro.user.grid.users.columns.firstName' => 'Pangalan',
    'oro.user.grid.users.columns.lastName' => 'Apelyido',
    'oro.user.grid.users.columns.createdAt' => 'Nilikha sa',
    'oro.user.grid.users.columns.updatedAt' => 'Na-update sa',
    'oro.user.grid.users.columns.enabled' => 'Estado',
    'oro.user.grid.roles.columns.label' => 'Label',
    'oro.user.grid.groups.columns.name' => 'Pangalan',
    'pim_title.user.index' => 'Mga gumagamit',
    'pim_title.user_role.index' => 'Mga tungkulin',
    'pim_title.user_group.index' => 'Mga grupo',
    'pim_title.system_configuration.index' => 'Konpigurasyon',
    'user.product_grid_filters' => 'Mga filter ng grid ng produkto',
    'user.default_product_grid_view.label' => 'Default na tanawin ng grid ng produkto',
    'user.default_grid_view.none' => 'Wala',
    'role.title' => 'tungkulin',
    'role.overview' => 'tungkulin',
    'role.edit' => 'I-edit ang tungkulin',
    'role.create' => 'Lumikha ng tungkulin',
    'rights.action' => 'Mga pahintulot',
    'oro_security.acl_group.user' => 'Mga gumagamit',
    'oro_security.acl_group.role' => 'Mga tungkulin',
    'oro_security.acl_group.group' => 'Mga grupo ng gumagamit',
    'oro_security.acl.user.view' => 'Listahan ng mga gumagamit',
    'oro_security.acl.user.create' => 'Lumikha ng isang gumagamit',
    'oro_security.acl.user.edit' => 'I-edit ang mga gumagamit',
    'oro_security.acl.user.delete' => 'Alisin ang isang gumagamit',
    'oro_security.acl.role.view' => 'Listahan ng tungkulin',
    'oro_security.acl.role.create' => 'Lumikha ng tungkulin',
    'oro_security.acl.role.edit' => 'I-edit ang mga tungkulin',
    'oro_security.acl.role.delete' => 'Alisin ang isang tungkulin',
    'oro_security.acl.group.view' => 'Listahan ng mga grupo ng gumagamit',
    'oro_security.acl.group.create' => 'Lumikha ng isang gumagamit na grupo',
    'oro_security.acl.group.edit' => 'I-edit ang gumagamit na mga grupo',
    'oro_security.acl.group.delete' => 'Alisin ang isang grupo ng gumagamit',
    'oro.security.access-level.BASIC' => 'User',
    'oro.security.access-level.LOCAL' => 'Yunit ng negosyo',
    'oro.security.access-level.DEEP' => 'Dibisyon',
    'oro.security.access-level.GLOBAL' => 'Organisasyon',
    'oro.security.access-level.SYSTEM' => 'Systema',
    'oro.security.access-level.NONE' => 'Wala',
    'No products to remove' => 'Walang mga produktong aalisin',
    'dot (.)' => 'tuldok (.)',
    'comma (,)' => 'kuwit (,)',
    'pim_dashboard.title' => 'Dashboard',
    'pim_dashboard.version' => 'Bersyon',
    'pim_dashboard.widget.last_operations.status' => 'Estado',
    'pim_dashboard.widget.last_operations.date' => 'Petsa',
    'pim_dashboard.widget.last_operations.type' => 'Uri',
    'pim_analytics.new_patch_available' => 'May bagong patse na',
    'pim_analytics.system_config.group.notification.title' => 'Mga notipikasyon',
    'pim_analytics.system_config.group.version_update.title' => 'Mga update ng bersyon',
    'pim_analytics.system_config.form.version_update.label' => 'Mga notipikasyon sa mga bagong bersyon',
    'pim_analytics.system_config.form.version_update.tooltip' => 'Magpadala ng bilin sa malayong server para makuha ang impormasyon tungkol sa pagpapalabas ng mga bagong patse',
    'pim_analytics.system_info.title' => 'Impormasyon ng sistema',
    'pim_analytics.system_info.download' => 'TXT',
    'pim_analytics.info_type.pim_edition' => 'Edisyon',
    'pim_analytics.info_type.pim_version' => 'Bersyon',
    'pim_analytics.info_type.pim_storage_driver' => 'Imbakan',
    'pim_analytics.info_type.pim_environment' => 'Kapaligiran',
    'pim_analytics.info_type.pim_install_time' => 'Oras ng pag-install',
    'pim_analytics.info_type.registered_bundles' => 'Mga nakarehistrong bigkis',
    'pim_analytics.info_type.nb_channels' => 'Bilang ng mga channel',
    'pim_analytics.info_type.nb_products' => 'Bilang ng mga produkto',
    'pim_analytics.info_type.nb_product_models' => 'Bilang ng mga modelo ng produkto',
    'pim_analytics.info_type.nb_variant_products' => 'Bilang ng mga baryante ng produkto',
    'pim_analytics.info_type.nb_family_variants' => 'Bilang ng mga baryante ng pamilya',
    'pim_analytics.info_type.nb_attributes' => 'Bilang ng mga katangian',
    'pim_analytics.info_type.nb_scopable_attributes' => 'Bilang ng mga katangiang masasaklaw',
    'pim_analytics.info_type.nb_localizable_attributes' => 'Bilang ng mga katangiang maisasalokal',
    'pim_analytics.info_type.nb_scopable_localizable_attributes' => 'Bilang ng mga katangiang maisasalokal at masasaklaw',
    'pim_analytics.info_type.nb_locales' => 'Bilang ng mga pinagmulan',
    'pim_analytics.info_type.nb_families' => 'Bilang ng mga pamilya',
    'pim_analytics.info_type.nb_users' => 'Bilang ng mga gumagamit',
    'pim_analytics.info_type.pim_storage_version' => 'Bersyon ng imbakan',
    'pim_analytics.info_type.os_version' => 'Bersyon ng OS',
    'pim_analytics.info_type.php_version' => 'Bersyon ng PHP',
    'pim_analytics.info_type.mysql_version' => 'Bersyon ng MySQL',
    'pim_analytics.info_type.mariadb_version' => 'Bersyon ng MariaDB',
    'pim_analytics.info_type.mongodb_version' => 'Bersyon ng MongoDB',
    'pim_analytics.info_type.server_version' => 'Bersyon ng server',
    'pim_analytics.info_type.php_extensions' => 'Mga ekstensyon ng PHP',
    'pim_analytics.acl.system_info.index' => 'Impormasyon ng sistema',
    'pim_menu.item.system_info' => 'Impormasyon ng sistema',
    'Job' => 'Trabaho',
    'Connector' => 'Taga-konekta',
    'pim_title.export_profile.index' => 'Pagluwas ng pamamahalang anyo',
    'pim_title.export_execution.index' => 'Iluwas ang kasaysayan sa pagsasakatuparan',
    'pim_title.export_execution.show' => 'Iluwas ang pagsasakatuparan | Mga Detalye',
    'pim_title.import_profile.index' => 'Pamamahala sa pag-angkat ng mga profile',
    'pim_title.import_execution.index' => 'I-angkat ang kasaysayan sa pagsasakatuparan',
    'pim_title.import_execution.show' => 'I-angkat ang mga pagsasakatuparan',
    'Status' => 'Estado',
    'pim_import_export.job' => 'Trabaho',
    'pim_import_export.connector' => 'Taga-konekta',
    'pim_import_export.status.0' => 'Handa',
    'pim_import_export.download_archive.archive' => 'i-download ang nabuong archive|i-download ang mga nabuong archive',
    'pim_import_export.download_archive.output' => 'i-download ang nabuong file|i-download ang mga nabuong file',
    'pim_import_export.download_archive.input' => 'i-download ang basahing file|i-download ang mga basahing file',
    'pim_import_export.download_archive.invalid_xlsx' => 'i-download ang imbalidong data',
    'pim_import_export.download_archive.invalid_csv' => 'i-download ang imbalidong data',
    'pim_import_export.notification.export.error' => 'Pagluwas<strong>%label%</strong>bigo',
    'pim_import_export.notification.export.warning' => 'Pagluwas<strong>%label%</strong>natapos ng may mga babala',
    'pim_import_export.notification.export.success' => 'Pagluwas<strong>%label%</strong>tapos',
    'pim_import_export.notification.import.error' => 'Pag-angkat<strong>%label%</strong>bigo',
    'pim_import_export.notification.import.warning' => 'Pag-angkat<strong>%label%</strong>natapos na may mga babala',
    'pim_import_export.notification.import.success' => 'Pag-angkat <strong>%label%</strong> tapos',
    'pim_import_export.list' => 'Pumili ng trabaho',
    'pim_import_export.job_profile.tab.job_content.title' => 'Laman',
    'export profile.title' => 'iluwas ang profile',
    'export profile.edit' => 'baguhin ang profile na pangluwas',
    'import profile.title' => 'i-angkat ang profile',
    'import profile.edit' => 'baguhin ang pangkalahatang ideya ng profile',
    'pim_importexport.acl.export_profile.index' => 'Tingnan ang listahan ng mga profile ng pagluwas',
    'pim_importexport.acl.export_profile.create' => 'Gumawa ng profile ng pagluwas',
    'btn.create.export profile' => 'gumawa ng profile pangluwas',
    'btn.create.import profile' => 'gumawa ng pangkalahatang ideya ng profile',
    'User' => 'Gumagamit',
    'Run demo' => 'Patakbuhin ang demo',
    'Product' => 'Produkto',
    'Attribute list' => 'Listahan ng katangian',
    'Attribute Group list' => 'Listahan ng grupo ng katangian',
    'Users' => 'Mga gumagamit',
    'Roles' => 'Mga tungkulin',
    'Groups' => 'Mga grupo',
    'Configuration' => 'Kompigurasyon',
    'Currency list' => 'Listahan ng pera',
    'Locale list' => 'Listahan ng lokal',
    'Logged in as' => 'Naka-log in bilang',
    'Logout' => 'Logout',
    'Login' => 'Login',
    'Previous' => 'Nakaraan',
    'Next' => 'Susunod',
    'Channel list' => 'Listahan ng tsanel',
    'Select file' => 'Pumili ng file',
    'Change file' => 'Ibahin ang file',
    'Remove file' => 'Tanggalin ang file',
    'Delete' => 'Burahin',
    'Save' => 'Save',
    'Cancel' => 'Kansel',
    'Get help' => 'Kumuha ng tulong',
    'My User' => 'Ang aking akawnt',
    'oro.form.choose_value' => 'Pumili ng isang halaga...',
    'Read more' => 'Basahin lalo',
    'oro.form.click_here_to_select' => 'Pindutin dito para pumili...',
    'Add' => 'Dagdagan',
    'Learn how to use this space' => 'Matuto kung paano gumamit ng sapce na ito',
    'How To Use Pinbar' => 'Paano gumamit ng Pinbar',
    'Pinbar' => 'Pinbar',
    'Favorites' => 'Mga paborito',
    'Most Viewed' => 'Karamihang pinapanuod',
    'Add this page to favorites' => 'Idagdag ang page na ito sa mga paborito',
    'Minimize the window to the pinbar' => 'Bawasan ang bintana sa pinbar',
    'Loading ...' => 'Naglo-load...',
    'Yes' => 'Oo',
    'No' => 'Hindi',
    'required' => '(kailangan)',
    'other_actions' => 'Iba pang mga aksyon',
    'pim_ui.system_config.form.loading_message_enabled.label' => 'Paganahin ang mga naglo-load na mga mensahe',
    'pim_ui.system_config.form.loading_message_enabled.tooltip' => 'E-display ang mga user na friendly na mensahe habang naghihintay sa pahina na maglo-load',
    'pim_ui.system_config.form.loading_messages.label' => 'Mayroong naglo-load na mga mensahe',
    'pim_ui.system_config.form.loading_messages.tooltip' => 'Lahat ng available na naglo-load na mga mensaheng hiwalay sa pamamagitan ng linyang breaks',
    'pim_ui.system_config.group.loading_message.title' => 'Naglo-load na mga mensahe',
  ),
  'validators' => 
  array (
    'Attribute code may contain only letters, numbers and underscore' => 'Ang code ng katangian ay maaari lamang maglaman ng mga letra, numero at salungguhit',
    'Attribute code may contain only letters (at least one), numbers and underscores' => 'Ang code ng katangian ay maaari lamang maglaman ng mga letra (kahit isa), mga numero at mga salungguhit',
    'This attribute type must be required' => 'Ang uri ng katangiang ito ay kinakailangan',
    'This attribute type can\'t be required' => 'Ang uri ng katangiang ito ay hindi maaaring kailanganin',
    'This attribute type can\'t have unique value' => 'Ang uri ng katangiang ito ay hindi maaaring magkaroon ng natatanging halaga',
    'No default value may be specified for this attribute type' => 'Walang default na halaga ang maaaring matukoy para sa uri ng katangiang ito',
    'This value should not be blank' => 'Ang halagang ito ay dapat hindi blangko',
    'Option code may contain only letters, numbers and underscores' => 'Ang code na pagpipilian ay maaari lamang maglaman ng mga letra, mga numero at mga salungguhit',
    'Option code may contain only letters (at least one), numbers and underscores' => 'Ang code na pagpipilian ay maaari lamang maglaman ng mga letra (kahit isa), mga numero at mga salungguhit',
    'This value should not be a decimal.' => 'Ang halagang ito ay hindi dapat desimal.',
    'The file extension is not allowed (allowed extensions: %extensions%).' => 'Ang ekstensyon ng file ay hindi pinapayagan (pinapayagang ekstensyon: %extensions%).',
    'The value %value% is already set on another product for the unique attribute %attribute%' => 'Ang halagang %value% ay nakatakda na sa ibang produkto para sa natatanging katangiang %attribute%',
    'regex.comma_or_semicolon.message' => 'Ang patlang na ito ay hindi dapat maglaman ng anumang kuwit o tuldok-kuwit.',
    'file.extensions.message' => 'Ang ekstensyon ng file ay hindi pinapayagan (pinapayagang ekstensyon: %extensions%).',
    'This type of value expects the use of {{ decimal_separator }} to separate decimals.' => 'Ang uri ng halagang ito ay umaasa sa paggamit ng {{ decimal_separator }} para paghiwalayin ang mga desimal.',
    'This type of value expects the use of dot (.) to separate decimals.' => 'Ang uri ng halagang ito ay umaasa sa paggamit ng tuldok (.) para paghiwalayin ang mga desimal.',
    'This type of value expects the use of comma (,) to separate decimals.' => 'Ang uri ng halagang ito ay umaasa sa paggamit ng kuwit (,) para paghiwalayin ang mga desimal.',
    'This type of value expects the use of the format {{ date_format }} for dates.' => 'Itong uri ng halagang ay umaasa sa paggamit ng format na {{ date_format }} para sa mga petsa.',
    'The category "%category%" has to be a root category.' => 'Ang kategoryang "%category%" ay dapat na isang kategoryang ugat.',
    'The attribute "%attributeCode%" does not exist.' => 'Ang katangiang "%attributeCode%" ay hindi umiiral.',
    'The attribute "%attributeCode%" is not a metric attribute.' => 'Ang katangiang "%attributeCode%" ay hindi isang metrik na katangian.',
    'The unit "%unitCode%" does not exist or does not belong to the default metric family of the given attribute "%attributeCode%".' => 'Ang yunit na "%unitCode%" ay hindi umiiral o hindi nabibilang sa default na pamilyang metrik ng ibinigay na katangian na "%attributeCode%".',
    'product_model.code.not_blank.message' => 'Ang code ng modelo ng produkto ay hindi dapat blangko.',
    'product_model.code.unique.message' => 'Ang parehong code ay nakatakda na sa ibang modelo ng produkto.',
    'pim_catalog.constraint.can_have_family_variant_empty_axis_value' => 'Ang katangiang "%attribute%" ay hindi maaaring maging blangko, dahil ito ay tinutukoy bilang isang aksis para sa entity na ito',
    'pim_catalog.constraint.can_have_family_variant_duplicate_axis_value' => 'Hindi maaaring itakda ang halagang "%values%" para sa aksis ng katangiang "%attributes%", dahil may ibang kapatid na entity na may ganito ring halaga',
    'pim_catalog.constraint.can_have_family_variant_unexpected_attribute' => 'Hindi maaaring itakda ang katangiang "%attribute%" sa entity na ito dahil wala ito sa pangkat ng mga katangian',
    'pim_catalog.constraint.cannot_have_product_model_as_parent' => 'Ang modelo ng produktong "%product_model%" ay hindi maaaring magkaroon ng modelo ng produktong "%parent_product_model%" bilang magulang',
    'pim_catalog.constraint.cannot_have_parent' => 'Ang modelo ng produktong "%product_model%" ay hindi maaaring magkaroon ng magulang',
    'pim_catalog.constraint.attribute_does_not_belong_to_family' => 'Ang katangiang "%attribute%" ay hindi nabibilang sa pamilyang "%family%"',
    'pim_catalog.constraint.variant_product_has_parent' => 'Ang baryanteng produktong "%variant_product%" ay dapat mayroong magulang',
    'pim_catalog.constraint.invalid_variant_product_parent' => 'Ang baryanteng produktong "%variant_product%" ay hindi maaaring magkaroon ng modelo ng produktong "%product_model%" bilang magulang, (ang modelo ng produktong ito ay maaari lamang magkaroon ng ibang mga modelo ng produkto bilang mga supling)',
    'pim_catalog.constraint.family_variant_attributes_unique' => 'Ang mga katangian ay dapat natatangi, "%attributes%" ay ginagamit ng maraming beses sa mga baryanteng pangkat ng katangian',
    'pim_catalog.constraint.family_variant_axes_unique' => 'Ang mga baryanteng aksis ay dapat na natatangi, "%attributes%" ay ginagamit ng maraming beses sa mga pangkat ng baryanteng katangian',
    'pim_catalog.constraint.family_variant_axes_immutable' => 'Ang mga baryanteng aksis ay hindi maaaring baguhin para sa antas na "%level%"',
    'pim_catalog.constraint.family_variant_axes_attribute_type' => 'Ang baryanteng aksis "%axis%" ay dapat isang boolean, simpleng pinili, o simpleng datos na reperensiya o isang metrik',
    'pim_catalog.constraint.family_variant_axes_wrong_type' => 'Ang baryanteng aksis "%axis%" ay hindi maaaring maisalokal, hindi masasaklaw at hindi partikular sa pinagmulan',
    'pim_catalog.constraint.family_variant_axes_number_of_axes' => 'Ang baryanteng pangkat ng katangian ay hindi maaaring magkaroon ng higit pa sa %max_axes_number% na mga aksis',
    'pim_catalog.constraint.family_variant_has_family_attribute' => '"%attribute%" na katangian ay hindi maidadagdag sa "%family_variant%" ng baryanteng pamilya, dahil hindi ito katangian ng "%family%" na pamilya',
    'pim_catalog.constraint.family_variant_level_do_not_exist' => 'Walang baryanteng katangian na naitakda para sa antas na "%level%"',
    'pim_catalog.constraint.family_variant_no_level' => 'Dapat ay mayroong kahit isang antas na matukoy sa baryanteng pamilya',
    'pim_catalog.constraint.family_variant_unique_attributes_in_last_level' => 'Ang natatanging katangiang "%attribute%" ay dapat maitakda sa antas ng produkto',
    'pim_catalog.constraint.0' => 'Isang hindi inaasahang error ang naganap.',
    'pim_catalog.constraint.100' => 'Hindi inaasahang halaga',
    'pim_catalog.constraint.200' => 'Isang panloob na error ang naganap',
    'pim_catalog.constraint.201' => 'Isang panloob na error ang naganap',
    'pim_catalog.constraint.205' => 'Isang panloob na error ang naganap',
    'pim_catalog.constraint.pim_immutable_product_model_validator' => 'Ang parehong code ay naitakda na sa ibang modelo ng produkto.',
    'This directory is not writable' => 'Ang direktoryo ay hindi nalalapatan.',
    'This directory is not valid' => 'Ang direktoryong ito ay hindi wasto.',
    'pim_import_export.job_instance.unknown_job_definition' => 'Nabigong lumikha ng isang %job_type% na mayroong hindi kilalang kahulugan ng trabaho',
    'This code is already taken' => 'Ang code na ito ay nakuha na',
  ),
  'jsmessages' => 
  array (
    'Area' => 'Sukat',
    ...
    'PIECE' => 'Piraso',
    'DOZEN' => 'Dosena',
    'system_filter_group' => 'Systema',
    'oro_filter.filters.manage' => 'Pamahalaan ang mga salaan',
    'oro_filter.placeholder.all' => 'Lahat',
    'Item deleted' => 'Ang aytem ay nabura',
    'Are you sure you want to delete this item?' => 'Sigurado ka bang gusto mong burahin ang aytem na ito?',
    'Delete Error' => 'Ibura ang error',
    'Are you sure you want to do remove selected items?' => 'Sigurado ka bang itanggal ang napiling mga aytems?',
    'Selected items were removed.' => 'Ang napiling mga aytems ay natanggal.',
    'Selected items were not removed.' => 'Ang napiling mga aytems ay natanggal.',
    'Please, select items to remove.' => 'Pakiusap, piliin ang mga aytems na itanggal.',
    'Cannot delete item.' => 'Hindi pwede mabura ang aytem.',
    'Refresh Confirmation' => 'I-refresh ang kompirmasyon',
    'Your local changes will be lost. Are you sure you want to refresh grid?' => 'Ang lokal na pagbabago ay mawawala. Sigurado ka bang i-refresh mo ang grid?',
    'Reset Confirmation' => 'I-reset ang kompirmasyon',
    'Your local changes will be lost. Are you sure you want to reset grid?' => 'Ang iyong lokal na pagbabago ay mawawala. Sigurado ka bang i-reset ang grid?',
    ...
    'Status' => 'Estado',
    'All' => 'Lahat',
    'Per page' => 'Kada pahina',
    'Mass Action Confirmation' => 'Malawakang Gawain para sa Kompirmasyon',
    'Mass action performed.' => 'Malawakang gawain na naisagawa.',
    'Mass action is not performed.' => 'Ang malawakang aksyon ay hindi naisagawa.',
    'Please, select items to perform mass action.' => 'Pakiusap, pumili ng mga aytems para maisagawa ang malawakang aksyon.',
    'Execution Confirmation' => 'Kumpirmasyon sa pagpapatupad',
    'Are you sure you want to do this?' => 'Sigurado ka bang gusto mo ito gawin?',
    'Action performed.' => 'Mga gawain na naisagawa na.',
    'Action is not performed.' => 'Ang gawain ay hindi pa naisagaw.',
    'Please, select item to perform action.' => 'Pakiusap, pumili ng aytem para maisagawa ang aksyon.',
    'View per page' => 'Pagtanaw kada pahina',
    'Enabled' => 'Pinagana',
    ...
    'oro.datagrid.noentities' => 'Walang mga rekord na nahahanap',
    'oro.datagrid.nocolumns' => 'Walang mga kolums na na konfigyur sa grid na ito',
    'oro.datagrid.pagination.label' => 'Pahina',
    'oro.datagrid.pagination.totalPages' => 'sa {{ totalPages }}',
    'oro.datagrid.pagination.totalRecords' => '{{ totalRecords }} mga rekord',
    'oro.datagrid.action.reset' => 'I-reset',
    'oro.datagrid.action.refresh' => 'I refresh',
    'oro_datagrid.select.all' => 'Lahat',
    'oro_datagrid.select.visible' => 'Makikita lahat',
    'oro_datagrid.select.none' => 'Wala',
    'oro_datagrid.select.select' => 'Pumili',
    'pim.grid.ajax_choice_filter.label_empty' => 'ay walang laman',
    'Available Columns' => 'Pwedeng magagamit na kolums',
    'Displayed Columns' => 'Ang napiling mga kolums',
    'datagrid_view.columns.min_message' => 'Pumili ka kahit isang datagrid kolum para ipakita',
    'pim.grid.mass_action.quick_export.title' => 'Madaliang pagluwas',
    'pim.grid.mass_action.quick_export.launched' => 'Ang madaliang pagluwas ay nailunsad na',
    'pim.grid.action.launch.title' => 'Ilunsad',
    'pim.grid.action.show.title' => 'Ipakita',
    'Please select view' => 'Pakiusap pumili ng tanawin',
    'Loading...' => 'Naglo-loading...',
    'View' => 'Tingnan',
    'grid.view_selector.flash.updated' => 'Datagrid na tanawin ang matagumpay na nai-update',
    'pim.grid.choice_filter.label_empty' => 'ay walang laman',
    'pim_datagrid.column_configurator.all_groups' => 'Lahat na mga grupo',
    'pim_datagrid.column_configurator.search' => 'Maghanap',
    'pim_datagrid.column_configurator.clear' => 'Malinaw',
    'pim_datagrid.column_configurator.displayed_columns' => 'Ang napiling mga kolums',
    'pim_datagrid.column_configurator.cancel' => 'Kansel',
    'pim_datagrid.column_configurator.remove_column' => 'Tanggal',
    'pim_datagrid.column_configurator.attribute_groups' => 'Mga grupo ng mga katangian',
    'pim_datagrid.mass_action.delete.confirm_title' => 'Kompirmadong pagtanggal',
    'pim_datagrid.mass_action.delete.confirm_ok' => 'Okay',
    'pim_datagrid.mass_action.delete.empty_selection' => 'Walang produkto na pinili',
    'grid.view_selector.default_view' => 'Default na pagtanaw',
    'grid.view_selector.save_changes' => 'I-save ang tanawin na ito',
    'grid.view_selector.remove' => 'Burahin ang tanawin na ito',
    'grid.view_selector.create_view' => 'Lumikha ng tanawin',
    'grid.view_selector.create' => 'Lumikha',
    'grid.view_selector.search' => 'Maghanap',
    'grid.view_selector.views' => 'Mga pagtanaw',
    'grid.view_selector.placeholder' => 'Pangalan sa bagong tanawin',
    'grid.view_selector.choose_label' => 'Pumili ng label sa tanawin',
    'grid.view_selector.confirmation.delete' => 'Kompirmadong pagtanggal',
    'grid.display_selector.label' => 'Ipakita',
    'pim_dashboard.widget.last_operations.status' => 'Estado',
    'pim_dashboard.widget.last_operations.date' => 'Petsa',
    'pim_dashboard.widget.last_operations.type' => 'Uri',
    'page_title.pim_dashboard_index' => 'Dashboard',
    'pim_connector.export.categories.selector.modal.cancel' => 'Kansel',
    'pim_connector.export.categories.selector.modal.confirm' => 'Ikumpirma',
    'pim_connector.export.categories.selector.edit' => 'I-Edit',
    'page_title.pim_importexport_export_profile_index' => 'Pagluwas ng pamamahalang anyo',
    'page_title.pim_importexport_export_execution_index' => 'Iluwas ang kasaysayan sa pagsasakatuparan',
    'page_title.pim_importexport_export_execution_show' => 'Iluwas ang pagsasakatuparan | Mga Detalye',
    'page_title.pim_importexport_import_profile_index' => 'Pamamahala sa pag-angkat ng mga profile',
    'page_title.pim_importexport_import_execution_index' => 'I-angkat ang kasaysayan sa pagsasakatuparan',
    'page_title.pim_importexport_import_execution_show' => 'I-angkat ang mga pagsasakatuparan',
    'pim_notification.report' => 'Ulat',
    'Close' => 'Sarado',
    'Update' => 'Update',
    'Selected Rows' => 'Piniling mga hanay',
    'Yes, Delete' => 'Oo, burahin',
    'Yes, I Agree' => 'Oo, sumasang-ayon ako',
    'Yes, do it' => 'Oo, gawin mo',
    'Ok, got it.' => 'Ok, nakuha ko.',
    'Cancel' => 'Kansel',
    'Delete Confirmation' => 'Tanggalin ang kompirmasyon',
    'Edit' => 'I-Edit',
    'Unexpected error occured. Please contact system administrator.' => 'Hindi inaasahang kamaliang nagaganap. Pakiusap makipag-ugnay sa system administrator.',
    'Yes, revoke' => 'Oo, iurong',
    'Revoke Confirmation' => 'Iurong ang kompirmasyon',
    'Now' => 'Ngayon',
    'Prev' => 'Nakaraan',
    'Next' => 'Susunod',
    'Today' => 'Ngayon',
    ...
    'Time Zone' => 'Oras zone',
    'Localized value' => 'Naisalokal na halaga',
    'Columns' => 'Mga hanay',
    'Datagrid Configuration' => 'Kompigurasyon ng datagrid',
    'Apply' => 'Ilapat',
    'Action' => 'Aksyon',
    'Unit' => 'Yunit',
    'Currency' => 'Pera',
    'jstree.all' => 'Lahat ng mga produkto',
    'jstree.unclassified' => 'Hindi nai-klasipikang mga produkto',
    'jstree.product.all' => 'Lahat ng mga produkto',
    'jstree.product.unclassified' => 'Hindi nai-klasipikang mga produkto',
    'jstree.no_tree' => 'Walang punong mayroon',
    'jstree.include_sub' => 'Kasama sa mga sub-kategorya',
    'jstree.loading' => 'Naglo-load...',
    'datetimepicker.days.Sunday' => 'Linggo',
    'datetimepicker.days.Monday' => 'Lunes',
    'datetimepicker.days.Tuesday' => 'Martes',
    'datetimepicker.days.Wednesday' => 'Miyerkules',
    'datetimepicker.days.Thursday' => 'Huwebes',
    'datetimepicker.days.Friday' => 'Biyernes',
    'datetimepicker.days.Saturday' => 'Sabado',
    ...
    'datetimepicker.months.February' => 'Pebrero',
    'datetimepicker.months.March' => 'Marso',
    'datetimepicker.months.April' => 'Abril',
    'datetimepicker.months.May' => 'Mayo',
    'datetimepicker.months.June' => 'Hunyo',
    'datetimepicker.months.July' => 'Hulyo',
    'datetimepicker.months.August' => 'Agosto',
    'datetimepicker.months.September' => 'Setyembre',
    'datetimepicker.months.October' => 'Oktubre',
    'datetimepicker.months.November' => 'Nobyembre',
    'datetimepicker.months.December' => 'Disyembre',
    ...
    'oro_config.form.config.title' => 'Kompigurasyon ng sistema',
    'oro_config.form.config.tab.system.title' => 'Systema',
    'oro_config.form.config.group.localization.title' => 'Lokalisasyon',
    'oro_config.form.config.group.localization.system_locale' => 'Wika',
    'oro_config.form.config.group.notification.title' => 'Mga notipikasyon',
    'oro_config.form.config.group.notification.system_notification' => 'Bagong mga bersyon sa mga notipikasyon',
    'oro_config.form.config.group.loading_message.title' => 'Naglo-load na mga mensahe',
    'oro_config.form.config.group.loading_message.label' => 'Hindi magawang mag-load ang mga mensahe',
    'oro_config.form.config.group.loading_messages.label' => 'Mayroong naglo-load na mga mensahe',
  ),
));
...
$catalogueTl->addFallbackCatalogue($catalogueEn_US);
