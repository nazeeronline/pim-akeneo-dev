...
$catalogue = new MessageCatalogue('pt_PT', array (
  ...
  'messages' => 
  array (
    'pim_connector.steps.dummy_reader.title' => 'Leitor dummy',
    'pim_connector.steps.product_reader.title' => 'Extração do produto',
    'pim_connector.steps.entity_reader.title' => 'Extração da entidade',
    'pim_connector.steps.csv_reader.title' => 'Leitor CSV',
    'pim_connector.steps.csv_product_reader.title' => 'Leitor do produto CSV',
    'pim_connector.steps.csv_category_reader.title' => 'Leitor da categoria CSV',
    'pim_connector.steps.csv_variant_group .title' => 'Leito do grupo variante CSV',
    'pim_connector.steps.dummy_processor.title' => 'Processador dummy',
    'pim_connector.steps.product_processor.title' => 'Criação do produto',
    'pim_connector.steps.variant_group_processor.title' => 'Criação / Atualização do grupo variante',
    'pim_connector.steps.category_processor.title' => 'Criação da categoria',
    'pim_connector.steps.association_processor.title' => 'Criação da associação',
    'pim_connector.steps.product_association_processor.title' => 'Criação da associação',
    'pim_connector.steps.group_processor.title' => 'Criação do grupo',
    'pim_connector.steps.attribute_processor.title' => 'Criação do atributo',
    'pim_connector.steps.attribute_option_processor.title' => 'Criação da opção do atributo',
    'pim_connector.steps.heterogeneous_processor.title' => 'Serializador do produto CSV',
    'pim_connector.steps.homogeneous_processor.title' => 'Serializador da entidade CSV',
    'pim_connector.steps.transformer_processor.title' => 'Transformação',
    'pim_connector.steps.dummy_writer.title' => 'Escritor dummy',
    'pim_connector.steps.file_writer.title' => 'Output',
    'pim_connector.steps.product_writer.title' => 'Armazenameno do produto',
    'pim_connector.steps.category_writer.title' => 'Armazenamento da categoria',
    'pim_connector.steps.variant_group_writer.title' => 'Armazenamento do grupo variante',
    'pim_connector.steps.writer.title' => 'Armazenamento da entidade',
    'pim_connector.steps.csv_writer.title' => 'Escritor CSV',
    'job_execution.summary.read' => 'ler',
    'job_execution.summary.write' => 'escrito',
    'job_execution.summary.skip' => 'ignorado',
    ...
    'job_execution.summary.skip_products' => 'produtos ignorados',
    'job_execution.summary.displayed' => 'primeiros avisos exibidos',
    'job_execution.summary.charset_validator.title' => 'codificação do ficheiro:',
    'job_execution.summary.charset_validator.skipped' => 'ignorado, extensão na lista branca',
    'job_execution.summary.product_skipped_no_diff' => 'produtos ignorados (sem diferenças)',
    'job_execution.summary.item_position' => 'linhas lidas',
    'batch_jobs.csv_product_export.label' => 'Exportar produto para o CSV',
    'batch_jobs.csv_product_export.export.label' => 'Exportar produto',
    'batch_jobs.csv_category_export.label' => 'Exportar categoria para o CSV',
    'batch_jobs.csv_category_export.export.label' => 'Exportar categoria',
    'batch_jobs.csv_attribute_export.label' => 'Exportar atributo para o CSV',
    'batch_jobs.csv_attribute_export.export.label' => 'Exportar atributo',
    'batch_jobs.csv_attribute_option_export.label' => 'Exportar opção de atributo para o CSV',
    'batch_jobs.csv_attribute_option_export.export.label' => 'Exportar opção de atributo',
    'batch_jobs.csv_association_type_export.label' => 'Exportar tipo de associação para o CSV',
    'batch_jobs.csv_association_type_export.export.label' => 'Exportar tipo de associação',
    'batch_jobs.csv_group_export.label' => 'Exportar grupo para o CSV',
    'batch_jobs.csv_group_export.export.label' => 'Exportar grupo',
    'batch_jobs.csv_variant_group_export.label' => 'Exportar variante do grupo para o CSV',
    'batch_jobs.csv_variant_group_export.export.label' => 'Exportar variante do grupo',
    'batch_jobs.csv_product_import.label' => 'Importar produto para o CSV',
    'batch_jobs.csv_product_import.validation.label' => 'Validação do ficheiro',
    'batch_jobs.csv_product_import.import.label' => 'Importar produto',
    'batch_jobs.csv_product_import.import_associations.label' => 'Importar associação',
    'batch_jobs.csv_product_model_import.validation.label' => 'Validação do ficheiro',
    'batch_jobs.csv_category_import.label' => 'Importar categoria para o CSV',
    'batch_jobs.csv_category_import.validation.label' => 'Validação do ficheiro',
    'batch_jobs.csv_category_import.import.label' => 'Importar categoria',
    'batch_jobs.csv_attribute_import.label' => 'Importar atributo para o CSV',
    'batch_jobs.csv_attribute_import.validation.label' => 'Validação do ficheiro',
    'batch_jobs.csv_attribute_import.import.label' => 'Importar atributo',
    'batch_jobs.csv_attribute_option_import.label' => 'Importar opção de atributo para o CSV',
    'batch_jobs.csv_attribute_option_import.validation.label' => 'Validação do ficheiro',
    'batch_jobs.csv_attribute_option_import.import.label' => 'Importar opção de atributo',
    'batch_jobs.csv_association_type_import.label' => 'Importar tipo de associação para o CSV',
    'batch_jobs.csv_association_type_import.validation.label' => 'Validação do ficheiro',
    'batch_jobs.csv_association_type_import.import.label' => 'Importar tipo de associação',
    'batch_jobs.csv_family_import.validation.label' => 'Validação do ficheiro',
    'batch_jobs.csv_family_variant_import.validation.label' => 'Validação do ficheiro',
    'batch_jobs.csv_group_import.label' => 'Importar grupo para o CSV',
    'batch_jobs.csv_group_import.validation.label' => 'Validação do ficheiro',
    'batch_jobs.csv_group_import.import.label' => 'Importar grupo',
    'batch_jobs.csv_variant_group_import.label' => 'Importar variante do grupo para o CSV',
    'batch_jobs.csv_variant_group_import.validation.label' => 'Validação do ficheiro',
    'batch_jobs.csv_variant_group_import.import.label' => 'Importar variante do grupo',
    'batch_jobs.csv_channel_import.validation.label' => 'Validação do ficheiro',
    'batch_jobs.csv_locale_import.validation.label' => 'Validação do ficheiro',
    'batch_jobs.csv_attribute_group_import.validation.label' => 'Validação do ficheiro',
    'batch_jobs.csv_currency_import.validation.label' => 'Validação do ficheiro',
    'batch_jobs.csv_group_type_import.validation.label' => 'Validação do ficheiro',
    'batch_jobs.xlsx_category_import.label' => 'Importação de categorias por XLSX',
    'batch_jobs.xlsx_category_import.validation.label' => 'Validação do ficheiro',
    'batch_jobs.xlsx_category_import.import.label' => 'Importar categoria',
    'batch_jobs.xlsx_association_type_import.label' => 'Importação de tipos de associação por XLSX',
    'batch_jobs.xlsx_association_type_import.validation.label' => 'Validação do ficheiro',
    'batch_jobs.xlsx_association_type_import.import.label' => 'Importar tipo de associação',
    'batch_jobs.xlsx_attribute_import.label' => 'Importação de atributos por XLSX',
    'batch_jobs.xlsx_attribute_import.validation.label' => 'Validação do ficheiro',
    'batch_jobs.xlsx_attribute_import.import.label' => 'Importar atributo',
    'batch_jobs.xlsx_attribute_option_import.label' => 'Importação de opções de atributos por XLSX',
    'batch_jobs.xlsx_attribute_option_import.validation.label' => 'Validação do ficheiro',
    'batch_jobs.xlsx_attribute_option_import.import.label' => 'Importar opção de atributo',
    'batch_jobs.xlsx_family_import.label' => 'Importação de famílias por XLSX',
    'batch_jobs.xlsx_family_import.validation.label' => 'Validação do ficheiro',
    'batch_jobs.xlsx_family_variant_import.validation.label' => 'Validação do ficheiro',
    'batch_jobs.xlsx_product_export.label' => 'Exportação de produtos em XLSX',
    'batch_jobs.xlsx_product_export.export.label' => 'Exportar produto',
    'batch_jobs.xlsx_product_import.label' => 'Importação de produtos por XLSX',
    'batch_jobs.xlsx_product_import.validation.label' => 'Validação do ficheiro',
    'batch_jobs.xlsx_product_import.import.label' => 'Importar produto',
    'batch_jobs.xlsx_product_import.import_associations.label' => 'Importar associação',
    'batch_jobs.xlsx_product_model_import.validation.label' => 'Validação do ficheiro',
    'batch_jobs.xlsx_group_export.label' => 'Exportação de grupos em XLSX',
    'batch_jobs.xlsx_group_export.export.label' => 'Exportar grupo',
    'batch_jobs.xlsx_variant_group_export.label' => 'Exportação de grupos variantes em XLSX',
    'batch_jobs.xlsx_variant_group_export.export.label' => 'Exportar variante do grupo',
    'batch_jobs.xlsx_group_import.label' => 'Importação de grupos por XLSX',
    'batch_jobs.xlsx_group_import.validation.label' => 'Validação do ficheiro',
    'batch_jobs.xlsx_group_import.import.label' => 'Importar grupo',
    'batch_jobs.xlsx_variant_group_import.label' => 'Importação de grupos variantes por XLSX',
    'batch_jobs.xlsx_variant_group_import.validation.label' => 'Validação do ficheiro',
    'batch_jobs.xlsx_variant_group_import.import.label' => 'Importação de grupos variantes',
    ...
    'batch_jobs.xlsx_category_export.export.label' => 'Exportar categoria',
    ...
    'batch_jobs.xlsx_channel_import.validation.label' => 'Validação do ficheiro',
    'batch_jobs.xlsx_locale_import.validation.label' => 'Validação do ficheiro',
    'batch_jobs.xlsx_attribute_group_import.validation.label' => 'Validação do ficheiro',
    'batch_jobs.xlsx_currency_import.validation.label' => 'Validação do ficheiro',
    'batch_jobs.xlsx_group_type_import.validation.label' => 'Validação do ficheiro',
    'Area' => 'Área',
    'ACRE' => 'Acre',
    'ARE' => 'Are',
    'ARPENT' => 'Arpent',
    ...
    'pim_api.acl.attribute_group.list' => 'Listar grupos de atributos',
    'pim_api.acl.category.list' => 'Listar categorias',
    'pim_api.acl.family.list' => 'Listar famílias',
    'pim_api.acl.channel.list' => 'Listar canais',
    'pim_api.acl.locale.list' => 'Listar linguagens',
    'pim_api.acl.currency.list' => 'Listar moedas',
    'pim_api.acl.association_type.list' => 'Listar tipos de associação',
    ...
    'pim_api.acl_group.locale' => 'Linguagens',
    ...
    'oro.filter.form.label_date_type_not_between' => 'não está entre',
    'oro.filter.form.label_date_type_more_than' => 'maior que',
    ...
    'oro_datagrid.no_data_hint %entityHint%' => '%entityHint% não existe.',
    'oro_datagrid.label_add_filter' => 'Gerir filtros',
    'oro_datagrid.label_loading_mask' => 'A carregar . . .',
    'oro.grid.mass_action.selected_rows' => 'Linhas Selecionadas',
    'oro.grid.mass_action.confirm_title' => 'Confirmação de ação em massa',
    'oro.grid.mass_action.confirm_content' => 'Tem a certeza que pretende fazer isso?',
    'oro.grid.mass_action.confirm_ok' => 'Sim, avançar',
    'oro.grid.mass_action.error_title' => 'Erro na ação em massa',
    'oro.grid.mass_action.error_content' => 'Não é possível executar a ação em massa',
    'oro.grid.mass_action.delete.label' => 'Eliminar',
    'oro.grid.mass_action.delete.confirm_title' => 'Confirmação de remoção em massa',
    'oro.grid.mass_action.delete.confirm_content' => 'Tem certeza que deseja eliminar os itens selecionados?',
    'oro.grid.datagrid.page_size.all' => 'Tudo',
    'oro.grid.mass_action.delete.success_message' => '{0} Nenhuma entidade foi removida | {1} Uma entidade foi removida | ]1,Inf[ %count% entidades foram removidas',
    'quick_export' => 'Exportação rápida',
    'import' => 'Importação',
    'export' => 'Exportação',
    'mass_edit' => 'Editar em massa',
    'datagrid_view.columns.min_message' => 'Deve selecionar pelo menos uma coluna da grelha para exibir',
    'datagrid_view.label.unique_message' => 'O nome deve ser único',
    'datagrid_view.label.not_blank_message' => 'O nome não deve estar em branco',
    'grid.view_selector.flash.created' => 'Vista de grelha criada com sucesso',
    'grid.view_selector.flash.removed' => 'Vista de grelha removida com sucesso',
    'grid.view_selector.flash.not_removable' => 'Não tem permissões para remover esta vista',
    'user.title' => 'Utilizador',
    'user.overview' => 'Utilizador',
    'Users Management' => 'Gestão de Utilizadores',
    'Create user' => 'Criar utilizador',
    'btn.create.user' => 'Criar utilizador',
    ...
    'Catalog locale' => 'Linguagem do catálogo',
    'Catalog scope' => 'Âmbito do catálogo',
    ...
    'Host' => 'Servidor',
    'Port' => 'Porta',
    'Last logged in' => 'Último registo de ínicio de sessão',
    'Login count' => 'Contagem de logins',
    ...
    'Primary' => 'primário',
    'Removed user' => 'Utilizador removido',
    'Role' => 'Função',
    'Owner' => 'Dono',
    'General' => 'Geral',
    'Entity' => 'Entidade',
    ...
    'Forgot your password?' => 'Esqueceu-se da sua senha?',
    'Username or Email' => 'Nome de Utilizador ou E-mail',
    'Forgot Password' => 'Esqueci-me da Password',
    'Request' => 'Pedido',
    'Check Email' => 'Verificar E-mail',
    ...
    'pim_user.group.tab.users.title' => 'Utilizadores',
    'oro.user.controller.group.message.saved' => 'Grupo gravado',
    'oro.user.controller.role.message.saved' => 'Função guardada',
    'oro.user.controller.user.message.saved' => 'Utilizador gravado',
    'oro.user.controller.status.message.saved' => 'Estado gravado',
    'oro.user.grid.users.columns.username' => 'Nome do Utilizador',
    'oro.user.grid.users.columns.email' => 'Email',
    'oro.user.grid.users.columns.firstName' => 'Primeiro nome',
    'oro.user.grid.users.columns.lastName' => 'Último nome',
    ...
    'pim_title.user.index' => 'Utilizadores',
    ...
    'role.title' => 'função',
    'role.overview' => 'função',
    'role.edit' => 'Editar um função',
    'role.create' => 'Criar função',
    'rights.action' => 'Permissões',
    'oro_security.acl_group.user' => 'Utilizadores',
    'oro_security.acl_group.role' => 'Funções',
    'oro_security.acl_group.group' => 'Grupos de utilizadores',
    'oro_security.acl.user.view' => 'Listar utilizadores',
    'oro_security.acl.user.create' => 'Criar utilizador',
    'oro_security.acl.user.edit' => 'Editar utilizador',
    'oro_security.acl.user.delete' => 'Remover utilizador',
    'oro_security.acl.role.view' => 'Listar funções',
    'oro_security.acl.role.create' => 'Criar função',
    'oro_security.acl.role.edit' => 'Editar funções',
    'oro_security.acl.role.delete' => 'Remover função',
    'oro_security.acl.group.view' => 'Listar grupos de utilizadores',
    'oro_security.acl.group.create' => 'Criar grupo de utilizadores',
    'oro_security.acl.group.edit' => 'Editar grupo de utilizadores',
    'oro_security.acl.group.delete' => 'Remover grupo de utilizadores',
    'oro.security.access-level.BASIC' => 'Utilizador',
    ...
    'No products to remove' => 'Não há produtos para remover',
    'dot (.)' => 'ponto (.)',
    'comma (,)' => 'vírgula (,)',
    'pim_catalog.constraint.product_identifier' => 'Estes identificadores "%s" não existem.',
    ...
    'pim_dashboard.title' => 'Painel',
    'pim_dashboard.version' => 'Versão',
    'pim_dashboard.link.label.product' => 'Gerir produtos',
    'pim_dashboard.link.label.category' => 'Gerir categorias',
    'pim_dashboard.link.label.attribute' => 'Gerir atributos',
    'pim_dashboard.link.label.family' => 'Gerir famílias',
    'pim_dashboard.widget.error.title' => 'Erro ao carregar widget',
    'pim_dashboard.widget.error.message' => 'Widget \'%alias%\' não existe',
    'pim_dashboard.widget.completeness.title' => '% de Dados completos nos Canais e Línguas',
    ...
    'pim_dashboard.widget.last_operations.profile name' => 'Nome do Perfil',
    'pim_dashboard.widget.last_operations.details' => 'Detalhes',
    'pim_dashboard.widget.last_operations.job_type.import' => 'Importação',
    'pim_dashboard.widget.last_operations.job_type.export' => 'Exportação',
    ...
    'pim_analytics.new_patch_available' => 'Nova atualização disponível',
    'pim_analytics.system_config.group.notification.title' => 'Notificações',
    'pim_analytics.system_config.group.version_update.title' => 'Atualização de versão',
    'pim_analytics.system_config.form.version_update.label' => 'Notificações de novas versões',
    'pim_analytics.system_config.form.version_update.tooltip' => 'Enviar pedido a um servidor remoto para obter informações sobre a existência de novas actualizações',
    ...
    'pim_analytics.info_type.registered_bundles' => 'Pacotes (bundles) registados',
    ...
    'pim_analytics.info_type.nb_locales' => 'Número de linguagens',
    'pim_analytics.info_type.nb_families' => 'Número de famílias',
    'pim_analytics.info_type.nb_users' => 'Número de utilizadores',
    'pim_analytics.info_type.pim_storage_version' => 'Versão de armazenamento',
    'pim_analytics.info_type.os_version' => 'Versão do sistema operativo',
    ...
    'Job' => 'Tarefa',
    'Connector' => 'Conector',
    'pim_title.export_profile.index' => 'Gestão de perfis de exportação',
    'pim_title.export_profile.edit' => 'Exportar perfis %job.label% | Editar',
    'pim_title.export_profile.show' => 'Exportar perfis %job.label% | Mostrar',
    'pim_title.export_execution.index' => 'Histórico de exportações realizadas',
    'pim_title.export_execution.show' => 'Execução de exportações | Detalhes',
    'pim_title.import_profile.index' => 'Gestão de perfis de importação',
    'pim_title.import_profile.edit' => 'Importar perfis %job.label% | Editar',
    'pim_title.import_profile.show' => 'Importar perfis %job.label% | Mostrar',
    'pim_title.import_execution.index' => 'Histórico importações realizadas',
    'pim_title.import_execution.show' => 'Execução de importações | Detalhes',
    ...
    'Collecting data about job execution...' => 'A recolher dados sobre a execução da tarefa...',
    'You must select a file to upload' => 'Deve selecionar um ficheiro para enviar',
    ...
    'pim_import_export.download_archive.output' => 'transferir ficheiro gerado | transferir ficheiros gerados',
    'pim_import_export.download_archive.input' => 'transferir ficheiro lido| transferir ficheiros lidos',
    'pim_import_export.download_archive.invalid_xlsx' => 'transferir dados inválidos',
    'pim_import_export.download_archive.invalid_csv' => 'transferir dados inválidos',
    'pim_import_export.notification.export.error' => 'Falha ao exportar <strong>%label%</strong>',
    'pim_import_export.notification.export.warning' => 'Exportar <strong>%label%</strong> terminou com alguns avisos',
    'pim_import_export.notification.export.success' => 'Exportação de <strong>%label%</strong> terminado com sucesso',
    'pim_import_export.notification.import.error' => 'Importação de <strong>%label%</strong> falhado',
    'pim_import_export.notification.import.warning' => 'Importar <strong>%label%</strong> terminou com alguns avisos',
    'pim_import_export.notification.import.success' => 'Importação de <strong>%label%</strong> terminado com sucesso',
    ...
    'pim_importexport.acl.export_profile.launch' => 'Executar um perfil de exportação',
    'pim_importexport.acl.export_profile.history' => 'Ver histórico de perfil de exportação',
    'pim_importexport.acl.import_profile.index' => 'Ver lista de perfis de importação',
    ...
    'pim_importexport.acl.import_profile.launch' => 'Lançar um perfil de importação',
    'pim_importexport.acl.import_profile.history' => 'Ver histórico de perfil de importação',
    'pim_importexport.acl.export_execution.index' => 'Ver lista de relatórios de exportação',
    'pim_importexport.acl.export_execution.show' => 'Ver detalhes do relatório de exportação',
    'pim_importexport.acl.export_execution.dl_log' => 'Transferir log de relatório de exportação',
    'pim_importexport.acl.export_execution.dl_files' => 'Transferir arquivos exportados',
    'pim_importexport.acl.import_execution.index' => 'Ver lista de relatórios de importação',
    'pim_importexport.acl.import_execution.show' => 'Ver detalhes do relatório de importação',
    'pim_importexport.acl.import_execution.dl_log' => 'Transferir log de relatório de importação',
    'pim_importexport.acl.import_execution.dl_files' => 'Transferir arquivos importados',
    ...
    'confirmation.remove.export profile' => 'Tem certeza que deseja eliminar o perfil de exportação %name%?',
    'confirmation.remove.import profile' => 'Tem certeza que deseja eliminar o perfil de importação %name%?',
    ...
    'flash.export.running' => 'A exportação está a ser executada',
    'flash.import.created' => 'A importação foi criada com sucesso',
    'flash.import.removed' => 'A importação foi removida',
    'flash.import.updated' => 'A exportação foi atualizada com sucesso',
    'flash.import.running' => 'A importação está a ser executada',
    'pane.accordion.properties' => 'Propriedades',
    'pane.accordion.global_settings' => 'Definições Gerais',
    'pane.accordion.filters' => 'Filtros',
    'popin.create.export_profile.title' => 'Criar um novo perfil de exportação',
    'popin.create.import_profile.title' => 'Criar um novo perfil de importação',
    'job_execution.summary.update' => 'atualizado',
    'User' => 'Utilizador',
    'Run demo' => 'Executar demonstração',
    'Product' => 'Produto',
    'Attribute list' => 'Lista de atributos',
    'Attribute Group list' => 'Lista de Grupos de Atributos',
    'Users' => 'Utilizadores',
    'Roles' => 'Funções',
    'Groups' => 'Grupos',
    'Configuration' => 'Configuração',
    'Currency list' => 'Lista de moedas',
    'Locale list' => 'Lista de linguagens',
    'Logged in as' => 'Iniciou sessão como',
  ...
  'validators' => 
  array (
    'akeneo_batch.job_instance.unknown_job_definition' => 'Falha ao criar um %job_type% com uma tarefa definida desconhecida',
    ...
    'This attribute type can\'t have unique value' => 'Este tipo de atributo não pode ter valor único',
    'No default value may be specified for this attribute type' => 'Nenhum valor padrão pode ser especificado para este tipo de atributo',
    'This value should be Yes or No' => 'Este valor deve ser Sim ou Não',
    ...
    'This directory is not writable' => 'Este diretório não tem permissões de escrita.',
    'This directory is not valid' => 'Este diretório não é válido.',
    'pim_import_export.job_instance.unknown_job_definition' => 'Falha ao criar um %job_type% com uma tarefa definida desconhecida',
    'This code is already taken' => 'Este código já está existe',
  ),
  'jsmessages' => 
  array (
    'Area' => 'Área',
    ...
    'oro_filter.filters.manage' => 'Gerir filtros',
    'oro_filter.placeholder.all' => 'Tudo',
    'Item deleted' => 'Item eliminado',
    'Are you sure you want to delete this item?' => 'Tem a certeza que pretende remover este item?',
    'Delete Error' => 'Erro a remover',
    'Are you sure you want to do remove selected items?' => 'Tem certeza que deseja remover os itens selecionados?',
    'Selected items were removed.' => 'Os itens selecionados foram removidos.',
    'Selected items were not removed.' => 'Os itens selecionados não foram removidos.',
    'Please, select items to remove.' => 'Por favor, Seleccione os itens a remover.',
    'Cannot delete item.' => 'Não é possível eliminar o item.',
    'Refresh Confirmation' => 'Confirmação de atualização',
    'Your local changes will be lost. Are you sure you want to refresh grid?' => 'As suas alterações locais serão perdidas. Tem a certeza de que deseja atualizar a grelha?',
    'Reset Confirmation' => 'Confirmação de Reset',
    'Your local changes will be lost. Are you sure you want to reset grid?' => 'Suas alterações locais serão perdidas. Tem a certeza de que deseja atualizar a grelha?',
    ...
    'Please, select items to perform mass action.' => 'Por favor, selecione itens para executar a ação em massa.',
    'Execution Confirmation' => 'Confirmar execução',
    'Are you sure you want to do this?' => 'Tem a certeza que pretende fazer isso?',
    'Action performed.' => 'Ação executada.',
    'Action is not performed.' => 'Ação não executada.',
    'Please, select item to perform action.' => 'Por favor, selecione o item para executar a ação.',
    'View per page' => 'Visualizações por página',
    'Enabled' => 'Ativo',
    'Disabled' => 'Inativo',
    'not_available' => 'N/A',
    'Yes' => 'Sim',
    ...
    'oro.datagrid.noentities' => 'Nenhum registo encontrado',
    'oro.datagrid.nocolumns' => 'Não há colunas configuradas para esta grelha',
    'oro.datagrid.pagination.label' => 'Página',
    'oro.datagrid.pagination.totalPages' => 'de {{ totalPages }}',
    'oro.datagrid.pagination.totalRecords' => '{{ totalRecords }} registos',
    'oro.datagrid.action.reset' => 'Reset / Restaurar',
    'oro.datagrid.action.refresh' => 'Atualizar',
    'oro_datagrid.select.all' => 'Tudo',
    'oro_datagrid.select.visible' => 'Tudo visível',
    ...
    'pim.grid.action.launch.title' => 'Iniciar',
    'pim.grid.action.show.title' => 'Mostrar',
    'Please select view' => 'Por favor, escolha uma vista',
    'Loading...' => 'A carregar...',
    'View' => 'Ver',
    'grid.view_selector.flash.updated' => 'Vista de grelha atualizada com sucesso',
    ...
    'pim_datagrid.column_configurator.title' => 'Seleção de colunas',
    ...
    'pim_datagrid.mass_action.delete.confirm_title' => 'Confirmar eliminação',
    'pim_datagrid.mass_action.delete.confirm_ok' => 'OK',
    'grid.view_selector.default_view' => 'Vista por defeito',
    'grid.view_selector.save_changes' => 'Gravar esta vista',
    'grid.view_selector.remove' => 'Eliminar esta vista',
    'grid.view_selector.create_view' => 'Criar vista',
    'grid.view_selector.create' => 'Criar',
    'grid.view_selector.search' => 'Pesquisar',
    'grid.view_selector.views' => 'Visualizações',
    'grid.view_selector.placeholder' => 'Nome da nova vista',
    'grid.view_selector.choose_label' => 'Escolher um nome para a vista',
    'grid.view_selector.confirmation.remove' => 'Tem certeza que deseja remover esta vista da grelha?',
    'grid.view_selector.confirmation.delete' => 'Confirmar eliminação',
    'pim_dashboard.widget.last_operations.empty' => 'Nenhuma operação encontrada',
    'pim_dashboard.widget.last_operations.status' => 'Estado',
    'pim_dashboard.widget.last_operations.date' => 'Data',
    'pim_dashboard.widget.last_operations.type' => 'Tipo',
    'pim_dashboard.widget.last_operations.profile_name' => 'Nome do Perfil',
    'pim_dashboard.widget.last_operations.details' => 'Detalhes',
    'pim_dashboard.widget.last_operations.job_type.import' => 'Importação',
    'pim_dashboard.widget.last_operations.job_type.export' => 'Exportação',
    'pim_dashboard.widget.last_operations.job_type.mass_edit' => 'Edição em massa',
    'pim_dashboard.widget.last_operations.job_type.quick_export' => 'Exportação rápida',
    'pim_dashboard.widget.header.view_all' => 'Ver tudo',
    'page_title.pim_dashboard_index' => 'Painel',
    ...
    'pim_connector.export.locales.validation.not_blank' => 'Uma linguagem deve ser selecionada, por favor, escolha uma para exportar.',
    'page_title.pim_importexport_export_profile_index' => 'Gestão de perfis de exportação',
    'page_title.pim_importexport_export_execution_index' => 'Histórico de exportações realizadas',
    'page_title.pim_importexport_export_execution_show' => 'Execução de exportações | Detalhes',
    'page_title.pim_importexport_import_profile_index' => 'Gestão de perfis de importação',
    'page_title.pim_importexport_import_execution_index' => 'Histórico importações realizadas',
    'page_title.pim_importexport_import_execution_show' => 'Execução de importações | Detalhes',
    'pim_notification.report' => 'Relatório',
    'Yes, Delete' => 'Sim, Eliminar',
    'Yes, I Agree' => 'Sim, Eu Concordo',
    'Yes, do it' => 'Sim, avançar',
    'Ok, got it.' => 'Ok, entendi.',
    'Cancel' => 'Cancelar',
    'Delete Confirmation' => 'Confirmar Eliminação',
    'Edit' => 'Editar',
    ...
    'Localized value' => 'Valor multi-linguagem',
    'Columns' => 'Colunas',
    'Datagrid Configuration' => 'Configuração da grelha de dados',
    'Apply' => 'Aplicar',
    'Action' => 'Ação',
    'Unit' => 'Unidade',
    'Currency' => 'Moeda',
    ...
    'jstree.no_tree' => 'Nenhuma árvore disponível',
    'jstree.include_sub' => 'Incluir subcategorias',
    'jstree.loading' => 'A carregar ...',
    'datetimepicker.days.Sunday' => 'Domingo',
    'datetimepicker.days.Monday' => 'Segunda',
    'datetimepicker.days.Tuesday' => 'Terça',
    'datetimepicker.days.Wednesday' => 'Quarta',
    'datetimepicker.days.Thursday' => 'Quinta',
    'datetimepicker.days.Friday' => 'Sexta',
    ...
    'oro_config.form.config.title' => 'Configuração de Sistema',
    ...
    'oro_config.form.config.group.notification.system_notification' => 'Notificações de novas versões',
  ),
));
