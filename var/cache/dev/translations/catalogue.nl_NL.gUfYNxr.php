...
$catalogue = new MessageCatalogue('nl_NL', array (
  'messages' => 
  array (
    'pim_connector.steps.dummy_reader.title' => 'Dummy lezer',
    'pim_connector.steps.product_reader.title' => 'Product extractie',
    'pim_connector.steps.entity_reader.title' => 'Entiteitextractie',
    'pim_connector.steps.csv_reader.title' => 'CSV-lezer',
    'pim_connector.steps.file_reader.invalid_item_columns_count' => 'Er worden %totalColumnsCount% kolommen verwacht, in werkelijkheid %itemColumnsCount% in %filePath%:%lineno%',
    'pim_connector.steps.csv_product_reader.title' => 'CSV product lezer',
    'pim_connector.steps.csv_category_reader.title' => 'CSV categorie lezer',
    'pim_connector.steps.dummy_processor.title' => 'Dummy verwerker',
    'pim_connector.steps.product_processor.title' => 'Product aanmaken',
    'pim_connector.steps.category_processor.title' => 'Categorie aanmaken',
    'pim_connector.steps.association_processor.title' => 'Associatie aanmaken',
    'pim_connector.steps.product_association_processor.title' => 'Associatie aanmaken',
    'pim_connector.steps.group_processor.title' => 'Groep aanmaken',
    'pim_connector.steps.attribute_processor.title' => 'Attribuut aanmaken',
    'pim_connector.steps.attribute_option_processor.title' => 'Attribuutoptie aanmaken',
    'pim_connector.steps.heterogeneous_processor.title' => 'CSV product serialiseren',
    'pim_connector.steps.homogeneous_processor.title' => 'CSV entiteit serialiseren',
    'pim_connector.steps.transformer_processor.title' => 'Transformatie',
    'pim_connector.steps.dummy_writer.title' => 'Dummy schrijver',
    'pim_connector.steps.file_writer.title' => 'Uitvoer',
    'pim_connector.steps.product_writer.title' => 'Productopslag',
    'pim_connector.steps.category_writer.title' => 'Categorieopslag',
    'pim_connector.steps.writer.title' => 'Entiteitopslag',
    'pim_connector.steps.csv_writer.title' => 'CSV-schrijver',
    'job_execution.summary.read' => 'lezen',
    'job_execution.summary.write' => 'geschreven',
    'job_execution.summary.skip' => 'overgeslagen',
    'job_execution.summary.create' => 'gecreëerd',
    'job_execution.summary.process' => 'verwerkt',
    'job_execution.summary.update_products' => 'geüpdatete producten',
    'job_execution.summary.process_products' => 'verwerkte producten',
    'job_execution.summary.skip_products' => 'overgeslagen producten',
    'job_execution.summary.displayed' => 'eerste waarschuwingen weergegeven',
    'job_execution.summary.charset_validator.title' => 'Bestandscodering:',
    'job_execution.summary.charset_validator.skipped' => 'overgeslagen, extensie in whitelist',
    'job_execution.summary.product_skipped_no_diff' => 'overgeslagen product (geen verschillen)',
    'job_execution.summary.product_skipped_no_associations' => 'product overgeslagen (geen associaties gedetecteerd)',
    'job_execution.summary.item_position' => 'lees de lijnen',
    'batch_jobs.csv_product_export.label' => 'Productexport in CSV',
    'batch_jobs.csv_product_export.export.label' => 'Productexport',
    'batch_jobs.csv_category_export.label' => 'Categorie-export in CSV',
    'batch_jobs.csv_category_export.export.label' => 'Categorie-export',
    'batch_jobs.csv_attribute_export.label' => 'Attribuutexport in CSV',
    'batch_jobs.csv_attribute_export.export.label' => 'Attribuutexport',
    'batch_jobs.csv_attribute_option_export.label' => 'Attribuutoptie-export in CSV',
    'batch_jobs.csv_attribute_option_export.export.label' => 'Attribuutoptie-export',
    'batch_jobs.csv_association_type_export.label' => 'Associatietype-export in CSV',
    'batch_jobs.csv_association_type_export.export.label' => 'Associatietype-export',
    'batch_jobs.csv_group_export.label' => 'Groepexport in CSV',
    'batch_jobs.csv_group_export.export.label' => 'Groepexport',
    'batch_jobs.csv_family_export.label' => 'Familie export in CSV',
    'batch_jobs.csv_family_export.export.label' => 'Familie export',
    'batch_jobs.csv_product_import.label' => 'Productimport in CSV',
    'batch_jobs.csv_product_import.validation.label' => 'Bestandsvalidatie',
    'batch_jobs.csv_product_import.import.label' => 'Productimport',
    'batch_jobs.csv_product_import.import_associations.label' => 'Productassociatie import',
    'batch_jobs.csv_product_model_import.validation.label' => 'Bestandsvalidatie',
    'batch_jobs.csv_category_import.label' => 'Categorie-import in CSV',
    'batch_jobs.csv_category_import.validation.label' => 'Bestandsvalidatie',
    'batch_jobs.csv_category_import.import.label' => 'Categorie-import',
    'batch_jobs.csv_attribute_import.label' => 'Attribuut-import in CSV',
    'batch_jobs.csv_attribute_import.validation.label' => 'Bestandsvalidatie',
    'batch_jobs.csv_attribute_import.import.label' => 'Attribuut-import',
    'batch_jobs.csv_attribute_option_import.label' => 'Attribuutoptie-import in CSV',
    'batch_jobs.csv_attribute_option_import.validation.label' => 'Bestandsvalidatie',
    'batch_jobs.csv_attribute_option_import.import.label' => 'Attribuutoptie-import',
    'batch_jobs.csv_association_type_import.label' => 'Associatietype-import in CSV',
    'batch_jobs.csv_association_type_import.validation.label' => 'Bestandsvalidatie',
    'batch_jobs.csv_association_type_import.import.label' => 'Associatietype-import',
    'batch_jobs.csv_family_import.label' => 'Familie import in CSV',
    'batch_jobs.csv_family_import.validation.label' => 'Bestandsvalidatie',
    'batch_jobs.csv_family_import.import.label' => 'Familie import',
    'batch_jobs.csv_family_variant_import.validation.label' => 'Bestandsvalidatie',
    'batch_jobs.csv_group_import.label' => 'Groep importeren in CSV',
    'batch_jobs.csv_group_import.validation.label' => 'Bestandsvalidatie',
    'batch_jobs.csv_group_import.import.label' => 'Groep importeren',
    'batch_jobs.csv_channel_export.label' => 'Kanaal export in CSV',
    'batch_jobs.csv_channel_export.export.label' => 'Kanaal export',
    'batch_jobs.csv_locale_export.label' => 'Locale export in CSV',
    'batch_jobs.csv_locale_export.export.label' => 'Locale export',
    'batch_jobs.csv_attribute_group_export.label' => 'Attribuut groep export in CSV',
    'batch_jobs.csv_attribute_group_export.export.label' => 'Attribuut groep export',
    'batch_jobs.csv_currency_export.label' => 'Valuta export in CSV',
    'batch_jobs.csv_currency_export.export.label' => 'Valuta export',
    'batch_jobs.csv_group_type_export.label' => 'Groepstype export in CSV',
    'batch_jobs.csv_group_type_export.export.label' => 'Groepstype export',
    'batch_jobs.csv_channel_import.label' => 'Kanaal import in CSV',
    'batch_jobs.csv_channel_import.validation.label' => 'Bestandsvalidatie',
    'batch_jobs.csv_channel_import.import.label' => 'Kanaal import',
    'batch_jobs.csv_locale_import.label' => 'Locale import in CSV',
    'batch_jobs.csv_locale_import.validation.label' => 'Bestandsvalidatie',
    'batch_jobs.csv_locale_import.import.label' => 'Locale import',
    'batch_jobs.csv_attribute_group_import.label' => 'Attribuut groep import in CSV',
    'batch_jobs.csv_attribute_group_import.validation.label' => 'Bestandsvalidatie',
    'batch_jobs.csv_attribute_group_import.import.label' => 'Attribuut groep import',
    'batch_jobs.csv_currency_import.label' => 'Valuta import in CSV',
    'batch_jobs.csv_currency_import.validation.label' => 'Bestandsvalidatie',
    'batch_jobs.csv_currency_import.import.label' => 'Valuta import',
    'batch_jobs.csv_group_type_import.label' => 'Groepstype-import in CSV',
    'batch_jobs.csv_group_type_import.validation.label' => 'Bestandsvalidatie',
    'batch_jobs.csv_group_type_import.import.label' => 'Groepstype import',
    'batch_jobs.xlsx_category_import.label' => 'Categorie import in XLSX',
    'batch_jobs.xlsx_category_import.validation.label' => 'Bestandsvalidatie',
    'batch_jobs.xlsx_category_import.import.label' => 'Categorie-import',
    'batch_jobs.xlsx_association_type_import.label' => 'Associatie type import in XLSX',
    'batch_jobs.xlsx_association_type_import.validation.label' => 'Bestandsvalidatie',
    'batch_jobs.xlsx_association_type_import.import.label' => 'Associatietype-import',
    'batch_jobs.xlsx_attribute_import.label' => 'Attribuut import in XLSX',
    'batch_jobs.xlsx_attribute_import.validation.label' => 'Bestandsvalidatie',
    'batch_jobs.xlsx_attribute_import.import.label' => 'Attribuut-import',
    'batch_jobs.xlsx_attribute_option_import.label' => 'Attribuut optie import in XLSX',
    'batch_jobs.xlsx_attribute_option_import.validation.label' => 'Bestandsvalidatie',
    'batch_jobs.xlsx_attribute_option_import.import.label' => 'Attribuutoptie-import',
    'batch_jobs.xlsx_family_import.label' => 'Familie import in XLSX',
    'batch_jobs.xlsx_family_import.validation.label' => 'Bestandsvalidatie',
    'batch_jobs.xlsx_family_import.import.label' => 'Familie import',
    'batch_jobs.xlsx_family_variant_import.validation.label' => 'Bestandsvalidatie',
    'batch_jobs.xlsx_product_export.label' => 'Product export in XLSX',
    'batch_jobs.xlsx_product_export.export.label' => 'Productexport',
    'batch_jobs.xlsx_product_import.label' => 'Product import in XLSX',
    'batch_jobs.xlsx_product_import.validation.label' => 'Bestandsvalidatie',
    'batch_jobs.xlsx_product_import.import.label' => 'Productimport',
    'batch_jobs.xlsx_product_import.import_associations.label' => 'Productassociatie import',
    'batch_jobs.xlsx_product_model_import.validation.label' => 'Bestandsvalidatie',
    'batch_jobs.xlsx_group_export.label' => 'Groep export in XLSX',
    'batch_jobs.xlsx_group_export.export.label' => 'Groepexport',
    'batch_jobs.xlsx_group_import.label' => 'Groep import in XLSX',
    'batch_jobs.xlsx_group_import.validation.label' => 'Bestandsvalidatie',
    'batch_jobs.xlsx_group_import.import.label' => 'Groep importeren',
    'batch_jobs.xlsx_family_export.label' => 'Familie export in XLSX',
    'batch_jobs.xlsx_family_export.export.label' => 'Familie export',
    'batch_jobs.xlsx_category_export.label' => 'Categorie export in XLSX',
    'batch_jobs.xlsx_category_export.export.label' => 'Categorie-export',
    'batch_jobs.xlsx_attribute_export.label' => 'Attribuut export in XLSX',
    'batch_jobs.xlsx_attribute_export.export.label' => 'Attribuut export in XLSX',
    'batch_jobs.xlsx_attribute_option_export.label' => 'Attribuut optie export in XLSX',
    'batch_jobs.xlsx_attribute_option_export.export.label' => 'Attribuut optie export in XLSX',
    'batch_jobs.xlsx_association_type_export.label' => 'Associatie type export in XLSX',
    'batch_jobs.xlsx_association_type_export.export.label' => 'Associatie type export in XLSX',
    'batch_jobs.xlsx_channel_export.label' => 'Kanaal export in XLSX',
    'batch_jobs.xlsx_channel_export.export.label' => 'Kanaal export',
    'batch_jobs.xlsx_locale_export.label' => 'Locale export in XLSX',
    'batch_jobs.xlsx_locale_export.export.label' => 'Locale export',
    'batch_jobs.xlsx_attribute_group_export.label' => 'Attribuut groep export in XLSX',
    'batch_jobs.xlsx_attribute_group_export.export.label' => 'Attribuut groep export',
    'batch_jobs.xlsx_currency_export.label' => 'Valuta export in XLSX',
    'batch_jobs.xlsx_currency_export.export.label' => 'Valuta export',
    'batch_jobs.xlsx_group_type_export.label' => 'Groepstype export in XLSX',
    'batch_jobs.xlsx_group_type_export.export.label' => 'Groepstype export',
    'batch_jobs.xlsx_channel_import.label' => 'Kanaal import in XLSX',
    'batch_jobs.xlsx_channel_import.validation.label' => 'Bestandsvalidatie',
    'batch_jobs.xlsx_channel_import.import.label' => 'Kanaal import',
    'batch_jobs.xlsx_locale_import.label' => 'Locale import in XLSX',
    'batch_jobs.xlsx_locale_import.validation.label' => 'Bestandsvalidatie',
    'batch_jobs.xlsx_locale_import.import.label' => 'Locale import',
    'batch_jobs.xlsx_attribute_group_import.label' => 'Attribuut groep import in XLSX',
    'batch_jobs.xlsx_attribute_group_import.validation.label' => 'Bestandsvalidatie',
    'batch_jobs.xlsx_attribute_group_import.import.label' => 'Attribuut groep import',
    'batch_jobs.xlsx_currency_import.label' => 'Valuta import in XLSX',
    'batch_jobs.xlsx_currency_import.validation.label' => 'Bestandsvalidatie',
    'batch_jobs.xlsx_currency_import.import.label' => 'Valuta import',
    'batch_jobs.xlsx_group_type_import.label' => 'Groepstype import in XLSX',
    'batch_jobs.xlsx_group_type_import.validation.label' => 'Bestandsvalidatie',
    'batch_jobs.xlsx_group_type_import.import.label' => 'Groepstype import',
    'Area' => 'Oppervlak',
    'ACRE' => 'Acre',
    'ARE' => 'Are',
    'ARPENT' => 'Arpent',
    ...
    'MILLIAMPEREHOUR' => 'Milliampere uur',
    ...
    'pim_api.acl.rights' => 'Web API machtigingen',
    'pim_api.acl.attribute.edit' => 'Attributen aanmaken en bijwerken',
    'pim_api.acl.attribute.list' => 'Attributen weergeven',
    'pim_api.acl.attribute_option.edit' => 'Attribuutopties aanmaken en bijwerken',
    'pim_api.acl.attribute_option.list' => 'Attribuutopties oplijsten',
    'pim_api.acl.attribute_group.list' => 'Attritbuutgroepen oplijsten',
    'pim_api.acl.category.edit' => 'Categorieën aanmaken en bijwerken',
    'pim_api.acl.category.list' => 'Categorieën weergeven',
    'pim_api.acl.family.edit' => 'Families aanmaken en bijwerken',
    'pim_api.acl.family.list' => 'Families weergeven',
    'pim_api.acl.channel.list' => 'Kanalen weergeven',
    'pim_api.acl.locale.list' => 'Lokalisaties weergeven',
    'pim_api.acl.currency.list' => 'Valuta weergeven',
    'pim_api.acl.association_type.list' => 'Associatietypes weergeven',
    'pim_api.acl_group.overall_access' => 'Algemene Web API-toegang',
    'pim_api.acl_group.attribute' => 'Attributen',
    'pim_api.acl_group.attribute_option' => 'Attribuutopties',
    'pim_api.acl_group.attribute_group' => 'Attribuutgroepen',
    'pim_api.acl_group.category' => 'Categorieën',
    'pim_api.acl_group.family' => 'Families',
    'pim_api.acl_group.channel' => 'Kanalen',
    'pim_api.acl_group.locale' => 'Lokalisaties',
    'pim_api.acl_group.currency' => 'Valuta',
    'pim_api.acl_group.association_type' => 'Associatietypes',
    ...
    'oro.filter.form.label_type_no' => 'nee',
    'oro.filter.form.label_type_contains' => 'bevat',
    'oro.filter.form.label_type_not_contains' => 'bevat geen',
    'oro.filter.form.label_type_equals' => 'is gelijk aan',
    'oro.filter.form.label_type_start_with' => 'begint met',
    'oro.filter.form.label_type_end_with' => 'eindigt op',
    'oro.filter.form.label_type_empty' => 'is leeg',
    'oro.filter.form.label_type_not_empty' => 'is niet leeg',
    'oro.filter.form.label_type_in_list' => 'in lijst',
    'oro.filter.form.label_date_type_between' => 'tussen',
    'oro.filter.form.label_date_type_not_between' => 'niet tussen',
    'oro.filter.form.label_date_type_more_than' => 'meer dan',
    'oro.filter.form.label_date_type_less_than' => 'minder dan',
    'oro.filter.form.label_not_selected' => 'Niet geselecteerd',
    'oro.filter.form.label_selected' => 'Geselecteerd',
    'oro_datagrid.no_data_hint %entityHint%' => 'Er bestaat geen %entityHint%.',
    'oro_datagrid.label_add_filter' => 'Filters beheren',
    'oro_datagrid.label_loading_mask' => 'Bezig met laden . . .',
    'oro.grid.mass_action.selected_rows' => 'Geselecteerde rijen',
    'oro.grid.mass_action.confirm_title' => 'Massa-actie-bevestiging',
    'oro.grid.mass_action.confirm_content' => 'Weet u zeker dat u dit wilt doen?',
    'oro.grid.mass_action.confirm_ok' => 'Ja, doen',
    'oro.grid.mass_action.error_title' => 'Massa-actie-foutmelding',
    'oro.grid.mass_action.error_content' => 'Kan massale actie niet uitvoeren',
    'oro.grid.mass_action.delete.label' => 'Verwijderen',
    'oro.grid.mass_action.delete.confirm_title' => 'Massa verwijderen bevestiging',
    'oro.grid.mass_action.delete.confirm_content' => 'Weet u zeker dat u de geselecteerde items wilt verwijderen?',
    'oro.grid.datagrid.page_size.all' => 'Alle',
    'oro.grid.mass_action.delete.success_message' => '{0} Geen entiteiten werden verwijderd|{1} Eén entiteit was verwijderd|{1}, Inf [%count% entiteiten werden verwijderd',
    'quick_export' => 'Snelle Export',
    'import' => 'Import',
    'export' => 'Export',
    'mass_edit' => 'Massa bewerken',
    'datagrid_view.columns.min_message' => 'U moet ten minste één dataraster kolom selecteren om weer te geven',
    'datagrid_view.label.unique_message' => 'Het label moet uniek zijn',
    'datagrid_view.label.not_blank_message' => 'Het label mag niet leeg zijn',
    'grid.view_selector.flash.created' => 'Datarasterweergave succesvol aangemaakt',
    'grid.view_selector.flash.removed' => 'Datarasterweergave succesvol verwijderd',
    'grid.view_selector.flash.not_removable' => 'U hoeft niet de rechten deze weergave te verwijderen',
    'user.title' => 'Gebruiker',
    'user.overview' => 'Gebruiker',
    'Users Management' => 'Gebruikersbeheer',
    'Create user' => 'Gebruiker aanmaken',
    'btn.create.user' => 'Gebruiker aanmaken',
    ...
    'Additional emails' => 'Extra e-mails',
    'Add another email' => 'Een ander e-mailadres toevoegen',
    'Catalog locale' => 'Catalogus lokalisatie',
    'Catalog scope' => 'Scope van catalogus',
    'Default tree' => 'Standaardstructuur',
    'Business Units' => 'Bedrijfsdivisies',
    'Email synchronization settings' => 'Synchronisatie-instellingen voor e-mail',
    'Host' => 'Host',
    'Port' => 'Poort',
    'Last logged in' => 'Laatst aangemeld',
    ...
    'Has role' => 'Heeft rol',
    'btn.create.role' => 'Rol aanmaken',
    '(default)' => 'Standaardmachtiging op entiteiten',
    'VIEW' => 'Bekijken',
    'CREATE' => 'Aanmaken',
    'EDIT' => 'Bewerken',
    'DELETE' => 'Verwijderen',
    ...
    'btn.create.user-group' => 'Groep aanmaken',
    'Has group' => 'Heeft groep',
    'Save and Close' => 'Opslaan en sluiten',
    'user-group.overview' => 'Groepen',
    'Log in' => 'Login',
    'Remember me on this computer' => 'Onthoud mijn gegevens op deze computer',
    'Forgot your password?' => 'Uw wachtwoord vergeten?',
    'Username or Email' => 'Gebruikersnaam of E-mail',
    'Forgot Password' => 'Wachtwoord vergeten',
    'Request' => 'Aanvragen',
    'Check Email' => 'E-mail controleren',
    'Go to homepage' => 'Ga naar de homepage',
    'pim_user.user.tab.general.title' => 'Algemeen',
    'pim_user.user.tab.additional.title' => 'Extra',
    'pim_user.user.tab.group_and_role.title' => 'Groepen en rollen',
    'pim_user.user.tab.password.title' => 'Wachtwoord',
    'pim_user.user.tab.business_unit.title' => 'Bedrijfsdivisies',
    'pim_user.user.tab.email_synchronization.title' => 'Synchronisatie-instellingen voor e-mail',
    'pim_user.group.tab.general.title' => 'Algemeen',
    'pim_user.group.tab.users.title' => 'Gebruikers',
    'oro.user.controller.group.message.saved' => 'Groep opgeslagen',
    'oro.user.controller.role.message.saved' => 'Rol opgeslagen',
    'oro.user.controller.user.message.saved' => 'Gebruiker opgeslagen',
    'oro.user.controller.status.message.saved' => 'Status opgeslagen',
    'oro.user.grid.users.columns.username' => 'Gebruikersnaam',
    'oro.user.grid.users.columns.email' => 'E-mail',
    'oro.user.grid.users.columns.firstName' => 'Voornaam',
    'oro.user.grid.users.columns.lastName' => 'Achternaam',
    'oro.user.grid.users.columns.createdAt' => 'Aangemaakt op',
    'oro.user.grid.users.columns.updatedAt' => 'Bijgewerkt op',
    'oro.user.grid.users.columns.enabled' => 'Status',
    'oro.user.grid.roles.columns.label' => 'Label',
    'oro.user.grid.groups.columns.name' => 'Naam',
    'pim_title.user.index' => 'Gebruikers',
    'pim_title.user_role.index' => 'Rollen',
    'pim_title.user_group.index' => 'Groepen',
    'pim_title.system_configuration.index' => 'Configuratie',
    'user.default_grid_view.none' => 'Geen',
    'user.timezone' => 'Tijdzone',
    'role.title' => 'rol',
    'role.overview' => 'rol',
    'role.edit' => 'Rol bewerken',
    'role.create' => 'Rol aanmaken',
    'rights.action' => 'Machtigingen',
    'oro_security.acl_group.user' => 'Gebruikers',
    'oro_security.acl_group.role' => 'Rollen',
    'oro_security.acl_group.group' => 'Gebruikersgroepen',
    'oro_security.acl.user.view' => 'Lijst gebruikers',
    'oro_security.acl.user.create' => 'Een gebruiker maken',
    'oro_security.acl.user.edit' => 'Gebruikers bewerken',
    'oro_security.acl.user.delete' => 'Een gebruiker verwijderen',
    'oro_security.acl.role.view' => 'Lijst met rollen',
    'oro_security.acl.role.create' => 'Maak een rol',
    'oro_security.acl.role.edit' => 'Rollen bewerken',
    'oro_security.acl.role.delete' => 'Een rol verwijderen',
    'oro_security.acl.group.view' => 'Lijst gebruikersgroepen',
    'oro_security.acl.group.create' => 'Maak een gebruikersgroep',
    'oro_security.acl.group.edit' => 'Bewerken van gebruikersgroepen',
    'oro_security.acl.group.delete' => 'De gebruikersgroep van een verwijderen',
    'oro.security.access-level.BASIC' => 'Gebruiker',
    'oro.security.access-level.LOCAL' => 'Bedrijfsdivisie',
    'oro.security.access-level.DEEP' => 'Divisie',
    'oro.security.access-level.GLOBAL' => 'Organisatie',
    'oro.security.access-level.SYSTEM' => 'Systeem',
    'oro.security.access-level.NONE' => 'Geen',
    'No products to remove' => 'Geen producten om te verwijderen',
    'dot (.)' => 'punt (.)',
    'comma (,)' => 'komma (,)',
    'pim_dashboard.title' => 'Dashboard',
    'pim_dashboard.version' => 'Versie',
    'pim_dashboard.link.label.product' => 'Producten beheren',
    'pim_dashboard.link.label.category' => 'Categorieën beheren',
    'pim_dashboard.link.label.attribute' => 'Attributen beheren',
    'pim_dashboard.link.label.family' => 'Families beheren',
    'pim_dashboard.widget.error.title' => 'Fout tijdens het laden van widget',
    'pim_dashboard.widget.error.message' => 'Widget \'%alias%\' bestaat niet',
    'pim_dashboard.widget.completeness.title' => 'Volledigheid over kanalen en lokalisaties',
    'pim_dashboard.widget.last_operations.title' => 'Laatste bewerkingen',
    'pim_dashboard.widget.last_operations.empty' => 'Geen bewerkingen beschikbaar',
    ...
    'pim_dashboard.widget.last_operations.profile name' => 'Profielnaam',
    ...
    'pim_dashboard.widget.last_operations.job_type.mass_edit' => 'Massabewerking',
    'pim_dashboard.widget.last_operations.job_type.quick_export' => 'Snelle export',
    'pim_analytics.new_patch_available' => 'Nieuwe patch beschikbaar',
    'pim_analytics.system_config.group.notification.title' => 'Meldingen',
    'pim_analytics.system_config.group.version_update.title' => 'Versie updates',
    'pim_analytics.system_config.form.version_update.label' => 'Meldingen nieuwe versies',
    'pim_analytics.system_config.form.version_update.tooltip' => 'Controleer of er nieuwe patches beschikbaar zijn',
    'pim_analytics.system_info.title' => 'Systeeminformatie',
    'pim_analytics.system_info.download' => 'TXT',
    'pim_analytics.info_type.pim_edition' => 'Editie',
    'pim_analytics.info_type.pim_version' => 'Versie',
    'pim_analytics.info_type.pim_storage_driver' => 'Opslag',
    'pim_analytics.info_type.pim_environment' => 'Omgeving',
    'pim_analytics.info_type.pim_install_time' => 'Tijd van installatie',
    'pim_analytics.info_type.registered_bundles' => 'Geregistreerde bundels',
    'pim_analytics.info_type.nb_channels' => 'Aantal kanalen',
    'pim_analytics.info_type.nb_products' => 'Aantal producten',
    'pim_analytics.info_type.nb_attributes' => 'Aantal attributen',
    'pim_analytics.info_type.nb_locales' => 'Aantal lokaliseringen',
    'pim_analytics.info_type.nb_families' => 'Aantal families',
    'pim_analytics.info_type.nb_users' => 'Aantal gebruikers',
    'pim_analytics.info_type.pim_storage_version' => 'Opslag versie',
    'pim_analytics.info_type.os_version' => 'Besturingssysteem versie',
    'pim_analytics.info_type.php_version' => 'PHP versie',
    'pim_analytics.info_type.mysql_version' => 'MySQL versie',
    'pim_analytics.info_type.mariadb_version' => 'MariaDB versie',
    'pim_analytics.info_type.mongodb_version' => 'MongoDB versie',
    'pim_analytics.info_type.server_version' => 'Server versie',
    'pim_analytics.info_type.php_extensions' => 'PHP extensies',
    'pim_analytics.acl.system_info.index' => 'Systeeminformatie',
    'pim_menu.item.system_info' => 'Systeeminformatie',
    'Job' => 'Taak',
    'Connector' => 'Connector',
    ...
    'Upload and import now' => 'Uploaden en nu importeren',
    ...
    'Show profile' => 'Profiel weergeven',
    'execution details' => 'verwerkingsdetails',
    'Step' => 'Stap',
    'Status' => 'Status',
    ...
    'pim_import_export.download_archive.archive' => 'download gegenereerd archief | download gegenereerde archieven',
    ...
    'pim_import_export.download_archive.invalid_xlsx' => 'download ongeldige data',
    'pim_import_export.download_archive.invalid_csv' => 'download ongeldige data',
    'pim_import_export.notification.export.error' => 'Export <strong>%label%</strong> mislukt',
    'pim_import_export.notification.export.warning' => 'Export <strong>%label%</strong> met enkele waarschuwingen beëindigd',
    'pim_import_export.notification.export.success' => 'Export <strong>%label%</strong> beëindigd',
    'pim_import_export.notification.import.error' => 'Import <strong>%label%</strong> mislukt',
    'pim_import_export.notification.import.warning' => 'Import <strong>%label%</strong> met enkele waarschuwingen beëindigd',
    'pim_import_export.notification.import.success' => 'Import <strong>%label%</strong> beëindigd',
    'pim_import_export.list' => 'Selecteer een taak',
    'pim_import_export.job_profile.tab.property.title' => 'Algemene eigenschappen',
    'pim_import_export.job_profile.tab.history.title' => 'Geschiedenis',
    'pim_import_export.job_profile.tab.job_content.title' => 'Inhoud',
    'export profile.title' => 'Profiel exporteren',
    'export profile.edit' => 'exportprofiel bewerken',
    'import profile.title' => 'Profiel importeren',
    ...
    'pim_importexport.acl.export_profile.property_edit' => 'Wijzig de algemene eigenschappen van een exportprofiel',
    'pim_importexport.acl.export_profile.property_show' => 'Toon de algemene eigenschappen van een exportprofiel',
    'pim_importexport.acl.export_profile.history' => 'Bekijk geschiedenis van exportprofiel',
    'pim_importexport.acl.export_profile.content_edit' => 'Wijzig de inhoud van een exportprofiel',
    'pim_importexport.acl.export_profile.content_show' => 'Toon inhoud van exportprofiel',
    ...
    'pim_importexport.acl.import_profile.history' => 'Bekijk geschiedenis van importprofiel',
    ...
    'pim_importexport.acl_group.export' => 'Exportprofielen',
    'pim_importexport.acl_group.import' => 'Importprofielen',
    'btn.create.export profile' => 'exportprofiel toevoegen',
    'btn.create.import profile' => 'importprofiel toevoegen',
    ...
    'flash.export.running' => 'De export is bezig',
    ...
    'flash.import.running' => 'De import is bezig',
    ...
    'job_execution.summary.update' => 'geüpdatet',
    'User' => 'Gebruiker',
    ...
    'Save' => 'Opslaan',
    'Cancel' => 'Annuleren',
    'Get help' => 'Help-informatie opvragen',
    'My User' => 'Mijn Account',
    'oro.form.choose_value' => 'Kies een waarde...',
    'Read more' => 'Lees meer',
    'oro.form.click_here_to_select' => 'Klik hier om te selecteren...',
    'Add' => 'Toevoegen',
    'Learn how to use this space' => 'Informatie over het gebruik van deze ruimte',
    'How To Use Pinbar' => 'Hoe de Pinbar te gebruiken',
    'Pinbar' => 'Pinbar',
    'Favorites' => 'Favorieten',
    'Most Viewed' => 'Meest bekeken',
    'Add this page to favorites' => 'Voeg deze pagina toe aan favorieten',
    'Minimize the window to the pinbar' => 'Minimaliseer het venster naar de pinbar',
  ...
  'validators' => 
  array (
    'akeneo_batch.job_instance.unknown_job_definition' => 'Het maken van een %job_type% met een onbekende taakdefinitie is mislukt',
    ...
    'Attribute code may contain only letters (at least one), numbers and underscores' => 'De attribuutcode mag alleen letters (één op z\'n minst), nummers en liggende streepjes bevatten',
    'This attribute type can\'t be used as a grid filter' => 'Dit attribuuttype kan niet worden gebruikt als een rasterfilter',
    'This code is not available' => 'Deze code is niet beschikbaar',
    'This attribute type must be required' => 'Dit attribuuttype moet worden vereist',
    'This attribute type can\'t be required' => 'Dit attribuuttype kan niet worden vereist',
    'This attribute type can\'t have unique value' => 'Dit attribuuttype kan geen unieke waarde hebben',
    'No default value may be specified for this attribute type' => 'Er kan geen standaardwaarde voor dit kenmerktype worden opgegeven',
    'This value should be Yes or No' => 'Deze waarde moet ja of nee zijn',
    'This value should not be blank' => 'Deze waarde mag niet leeg zijn',
    'Option code may contain only letters, numbers and underscores' => 'Optiecode kan alleen letters, cijfers en onderstrepingstekens bevatten',
    'Option code may contain only letters (at least one), numbers and underscores' => 'De optiecode mag alleen letters (één op z\'n minst), nummers en liggende streepjes bevatten',
    'This value should not be a decimal.' => 'Deze waarde kan geen decimaal zijn.',
    'The file extension is not allowed (allowed extensions: %extensions%).' => 'De bestandsextensie is niet toegestaan (toegestane extensies: %extensions%).',
    'The value %value% is already set on another product for the unique attribute %attribute%' => 'De waarde %value% is al ingesteld op een ander product voor the unieke attribuut %attribute%',
    'regex.comma_or_semicolon.message' => 'Dit veld mag geen komma of puntkomma bevatten.',
    'file.extensions.message' => 'De bestandsextensie is niet toegestaan (toegestane extensies: %extensions%).',
    'This type of value expects the use of {{ decimal_separator }} to separate decimals.' => 'Dit type waarde verwacht een {{ decimal_separator }} om decimalen te scheiden.',
    'This type of value expects the use of dot (.) to separate decimals.' => 'Dit type waarde verwacht een punt (.) om decimalen te scheiden.',
    'This type of value expects the use of comma (,) to separate decimals.' => 'Dit type waarde verwacht een komma (,) om decimalen te scheiden.',
    'This type of value expects the use of arabic decimal separator (٫) to separate decimals.' => 'Dit type waarde verwacht een arabisch decimaal scheidingsteken (٫) om decimalen te scheiden.',
    'This type of value expects the use of the format {{ date_format }} for dates.' => 'Dit type waarde verwacht gebruik van het {{ date_format }} formaat voor datums.',
    'pim_catalog.constraint.product_identifier' => 'Deze id\'s "%s" bestaan niet.',
    'pim_catalog.constraint.0' => 'Er is een onverwachte fout opgetreden.',
    'pim_catalog.constraint.100' => 'Onverwachte waarde',
    'pim_catalog.constraint.101' => 'Dit veld verwacht een Boolean invoer (ja- of nee-waarde).',
    'pim_catalog.constraint.102' => 'Dit veld verwacht een Float invoer (Zwevendekommagetal).',
    'pim_catalog.constraint.103' => 'Dit veld verwacht een integer (afgerond getal).',
    'pim_catalog.constraint.104' => 'Dit veld verwacht een numerieke invoer.',
    'pim_catalog.constraint.105' => 'Dit veld verwacht tekstinvoer.',
    'pim_catalog.constraint.106' => 'Dit veld verwacht een array als invoer.',
    'pim_catalog.constraint.107' => 'Dit veld verwacht een array van arrays als invoer.',
    'pim_catalog.constraint.200' => 'Er is een interne fout opgetreden',
    'pim_catalog.constraint.201' => 'Er is een interne fout opgetreden',
    'pim_catalog.constraint.202' => 'Dit veld verwacht een numerieke invoer.',
    'pim_catalog.constraint.203' => 'Dit veld verwacht tekstinvoer.',
    'pim_catalog.constraint.204' => 'Dit veld verwacht tekstinvoer.',
    'pim_catalog.constraint.205' => 'Er is een interne fout opgetreden',
    'pim_catalog.constraint.300' => 'Dit veld verwacht een geldig entiteit-code.',
    'pim_catalog.constraint.301' => 'Dit veld verwacht een geldige scope en regio-instelling.',
    'pim_catalog.constraint.302' => 'Dit veld verwacht een geldige scope.',
    'pim_catalog.constraint.303' => 'Dit veld verwacht een geldig formaat voor associaties.',
    'This directory is not writable' => 'Deze map is niet schrijfbaar.',
  ...
  array (
    ...
    'to' => 'tot',
    'and' => 'en',
    'system_filter_group' => 'Systeem',
    'oro_filter.filters.manage' => 'Filters beheren',
    ...
    'Are you sure you want to do remove selected items?' => 'Weet u zeker dat u de geselecteerde items wilt verwijderen?',
    'Selected items were removed.' => 'Geselecteerde items zijn verwijderd.',
    'Selected items were not removed.' => 'Geselecteerde items zijn niet verwijderd.',
    'Please, select items to remove.' => 'Selecteer de items die u wilt verwijderen.',
    'Cannot delete item.' => 'Kan item niet verwijderen.',
    'Refresh Confirmation' => 'Bevestiging vernieuwen',
    'Your local changes will be lost. Are you sure you want to refresh grid?' => 'Uw lokale wijzigingen zullen verloren gaan. Weet u zeker dat u het raster wilt herstellen?',
    'Reset Confirmation' => 'Bevestiging resetten',
    'Your local changes will be lost. Are you sure you want to reset grid?' => 'Uw lokale wijzigingen zullen verloren gaan. Weet u zeker dat u het raster wilt herstellen?',
    ...
    'All' => 'Alle',
    'Per page' => 'Per pagina',
    'Mass Action Confirmation' => 'Massa-actie-bevestiging',
    'Mass action performed.' => 'Massa-actie uitgevoerd.',
    'Mass action is not performed.' => 'Massa-actie is niet uitgevoerd.',
    'Please, select items to perform mass action.' => 'Selecteer items om massale actie uit te voeren.',
    'Execution Confirmation' => 'Bevestiging van de uitvoering',
    'Are you sure you want to do this?' => 'Weet u zeker dat u dit wilt doen?',
    'Action performed.' => 'Actie uitgevoerd.',
    'Action is not performed.' => 'Actie is niet uitgevoerd.',
    'Please, select item to perform action.' => 'Selecteer item om actie uit te voeren.',
    'View per page' => 'Bekijk per pagina',
    'Enabled' => 'Ingeschakeld',
    'Disabled' => 'Uitgeschakeld',
    'not_available' => 'Niet beschikbaar',
    'Yes' => 'Ja',
    'No' => 'Nee',
    'oro.datagrid.entityHint' => 'Entiteit',
    'oro.datagrid.noentities' => 'Geen records gevonden',
    'oro.datagrid.nocolumns' => 'Geen kolommen geconfigureerd voor dit raster',
    'oro.datagrid.pagination.label' => 'Pagina',
    'oro.datagrid.pagination.totalPages' => 'van {{ totalPages }}',
    'oro.datagrid.pagination.totalRecords' => '{{ totalRecords }} records',
    'oro.datagrid.action.reset' => 'Resetten',
    'oro.datagrid.action.refresh' => 'Vernieuwen',
    ...
    'datagrid_view.columns.min_message' => 'U moet ten minste één dataraster kolom selecteren om weer te geven',
    'pim.grid.mass_action.quick_export.title' => 'Snelle Export',
    'pim.grid.mass_action.quick_export.launched' => 'Snelle export is gelanceerd',
    'pim.grid.action.launch.title' => 'Starten',
    'pim.grid.action.show.title' => 'Toon',
    'Please select view' => 'Selecteer weergave',
    'Loading...' => 'Laden...',
    'View' => 'Bekijken',
    'grid.view_selector.flash.updated' => 'Datarasterweergave succesvol bijgewerkt',
    'pim.grid.choice_filter.label_contains' => 'bevat',
    'pim.grid.choice_filter.label_does_not_contain' => 'bevat geen',
    'pim.grid.choice_filter.label_equal' => 'is gelijk aan',
    'pim.grid.choice_filter.label_start_with' => 'begint met',
    'pim.grid.choice_filter.label_empty' => 'is leeg',
    'pim.grid.choice_filter.label_not_empty' => 'is niet leeg',
    'pim.grid.choice_filter.label_in_list' => 'in lijst',
    'pim.grid.price_filter.label' => 'Valuta',
    'pim.grid.category_filter.done' => 'Gedaan',
    'pim_datagrid.column_configurator.label' => 'Kolommen',
    'pim_datagrid.column_configurator.all_groups' => 'Alle groepen',
    'pim_datagrid.column_configurator.search' => 'Zoeken',
    'pim_datagrid.column_configurator.clear' => 'Opruimen',
    'pim_datagrid.column_configurator.displayed_columns' => 'Geselecteerde kolommen',
    'pim_datagrid.column_configurator.apply' => 'Toepassen',
    'pim_datagrid.column_configurator.cancel' => 'Annuleren',
    'pim_datagrid.column_configurator.remove_column' => 'Verwijderen',
    'pim_datagrid.column_configurator.attribute_groups' => 'Attribuutgroepen',
    'pim_datagrid.mass_action.delete.confirm_title' => 'Verwijderen bevestigen',
    'pim_datagrid.mass_action.delete.confirm_ok' => 'OK',
    'pim_datagrid.mass_action.delete.empty_selection' => 'Geen product geselecteerd',
    'grid.view_selector.default_view' => 'Standaardweergave',
    'grid.view_selector.save_changes' => 'Deze weergave opslaan',
    'grid.view_selector.remove' => 'Deze weergave verwijderen',
    'grid.view_selector.create_view' => 'Weergave maken',
    'grid.view_selector.create' => 'Aanmaken',
    'grid.view_selector.search' => 'Zoeken',
    'grid.view_selector.views' => 'Weergaves',
    'grid.view_selector.placeholder' => 'Naam van nieuwe weergave',
    'grid.view_selector.choose_label' => 'Kies een label voor de weergave',
    'grid.view_selector.confirmation.delete' => 'Verwijderen bevestigen',
    'pim_dashboard.widget.last_operations.empty' => 'Geen bewerkingen beschikbaar',
    'pim_dashboard.widget.last_operations.status' => 'Status',
    'pim_dashboard.widget.last_operations.date' => 'Datum',
    'pim_dashboard.widget.last_operations.type' => 'Type',
    'pim_dashboard.widget.last_operations.profile_name' => 'Profielnaam',
    'pim_dashboard.widget.last_operations.details' => 'Details',
    'pim_dashboard.widget.last_operations.warning_count' => 'Waarschuwingen',
    'pim_dashboard.widget.last_operations.job_type.import' => 'Import',
    'pim_dashboard.widget.last_operations.job_type.export' => 'Export',
    'pim_dashboard.widget.last_operations.job_type.mass_edit' => 'Massabewerking',
    'pim_dashboard.widget.last_operations.job_type.quick_export' => 'Snelle export',
    'pim_dashboard.widget.completeness.load_more' => 'Laad meer...',
    'pim_dashboard.widget.header.view_all' => 'Alles weergeven',
    'page_title.pim_dashboard_index' => 'Dashboard',
    'job_execution.summary.display_item' => 'Object weergeven',
    'job_execution.summary.hide_item' => 'Object verbergen',
    'pim_connector.export.categories.selector.modal.title' => 'Categorie selectie',
    'pim_connector.export.categories.selector.modal.cancel' => 'Annuleren',
    'pim_connector.export.categories.selector.label' => '{0} alle producten |{1} één categorie geselecteerd |] 1, Inf [{{ count }} categorieën geselecteerd',
    'pim_connector.export.categories.selector.edit' => 'Bewerken',
    'pim_connector.export.categories.selector.title' => 'Selecteer categorieën',
    'pim_connector.export.locales.validation.not_blank' => 'Één landinstelling moet worden geselecteerd, kies een landinstelling om te exporteren.',
    'page_title.pim_importexport_export_profile_index' => 'Beheer van exportprofielen',
    'page_title.pim_importexport_export_execution_index' => 'Exportverwerkingen geschiedenis',
    'page_title.pim_importexport_export_execution_show' => 'Exportverwerkingen | Details',
    'page_title.pim_importexport_import_profile_index' => 'Beheer van importprofielen',
    'page_title.pim_importexport_import_execution_index' => 'Importverwerkingen geschiedenis',
    'page_title.pim_importexport_import_execution_show' => 'Importverwerkingen | Details',
    'pim_notification.report' => 'Rapporteer',
    'Yes, Delete' => 'Ja, verwijderen',
    'Yes, I Agree' => 'Ja, ik ga akkoord',
    'Yes, do it' => 'Ja, doen',
    'Ok, got it.' => 'Okee, begrepen.',
    'Cancel' => 'Annuleren',
    'Delete Confirmation' => 'Verwijderen bevestigen',
    'Edit' => 'Bewerken',
    'Unexpected error occured. Please contact system administrator.' => 'Onverwachte fout opgetreden. Neem contact op met de systeembeheerder.',
    'Prev' => 'Vorige',
    'Next' => 'Volgende',
    'Today' => 'Vandaag',
    'Wk' => 'Wk',
    ...
    'Unit' => 'Eenheid',
    'Currency' => 'Valuta',
    'jstree.all' => 'Alle producten',
    'jstree.unclassified' => 'Niet-geclassificeerde producten',
    'jstree.product.all' => 'Alle producten',
    'jstree.product.unclassified' => 'Niet-geclassificeerde producten',
    'jstree.no_tree' => 'Geen structuur beschikbaar',
    'jstree.include_sub' => 'Inclusief subcategorieën',
    'jstree.loading' => 'Bezig met laden...',
    ...
    'datetimepicker.days.Thursday' => 'donderdag',
    'datetimepicker.days.Friday' => 'vrijdag',
    'datetimepicker.days.Saturday' => 'zaterdag',
    'datetimepicker.daysShort.Sun' => 'zo',
    'datetimepicker.daysShort.Mon' => 'ma',
    'datetimepicker.daysShort.Tue' => 'di',
    'datetimepicker.daysShort.Wed' => 'woe',
    'datetimepicker.daysShort.Thu' => 'do',
    'datetimepicker.daysShort.Fri' => 'vrij',
    'datetimepicker.daysShort.Sat' => 'zat',
    'datetimepicker.daysMin.Su' => 'zo',
    'datetimepicker.daysMin.Mo' => 'ma',
    'datetimepicker.daysMin.Tu' => 'di',
    'datetimepicker.daysMin.We' => 'wo',
    'datetimepicker.daysMin.Th' => 'do',
    'datetimepicker.daysMin.Fr' => 'vr',
    'datetimepicker.daysMin.Sa' => 'za',
    ...
    'datetimepicker.monthsShort.May' => 'mei',
    ...
    'oro_config.form.config.title' => 'Systeemconfiguratie',
    'oro_config.form.config.tab.system.title' => 'Systeem',
    'oro_config.form.config.group.localization.title' => 'Lokalisatie',
    'oro_config.form.config.group.localization.system_locale' => 'Taal',
    'oro_config.form.config.group.notification.title' => 'Meldingen',
    'oro_config.form.config.group.notification.system_notification' => 'Meldingen nieuwe versies',
  ),
));
...
$catalogueNl->addFallbackCatalogue($catalogueEn_US);
