...
if ($lazyLoad) {
    return $this->services['pim_catalog.normalizer.standard.product.product_value'] = $this->createProxy('ProductValueNormalizer_dbdbae4', function () {
        return \ProductValueNormalizer_dbdbae4::staticProxyConstructor(function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) {
