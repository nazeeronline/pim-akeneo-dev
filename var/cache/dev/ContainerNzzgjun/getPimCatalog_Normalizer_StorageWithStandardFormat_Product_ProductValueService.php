...
if ($lazyLoad) {
    return $this->services['pim_catalog.normalizer.storage_with_standard_format.product.product_value'] = $this->createProxy('ProductValueNormalizer_9e06bdf', function () {
        return \ProductValueNormalizer_9e06bdf::staticProxyConstructor(function (&$wrappedInstance, \ProxyManager\Proxy\LazyLoadingInterface $proxy) {
