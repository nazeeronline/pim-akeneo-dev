...
// Returns the private 'pim_catalog.query.filter.product_model_registry' shared service.

$this->services['pim_catalog.query.filter.product_model_registry'] = $instance = new \Akeneo\Pim\Enrichment\Component\Product\Query\Filter\FilterRegistry(${($_ = isset($this->services['pim_catalog.repository.attribute']) ? $this->services['pim_catalog.repository.attribute'] : $this->getPimCatalog_Repository_AttributeService()) && false ?: '_'});
